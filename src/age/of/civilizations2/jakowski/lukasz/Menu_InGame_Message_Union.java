...
class Menu_InGame_Message_Union
extends SliderMenu {
    ...
    protected Menu_InGame_Message_Union() {
    ...
    protected Menu_InGame_Message_Union(int onCivID, int iMessageID, int iValue) {
        ...
        this.initMenu(new SliderMenuTitle(CFG.langManager.get("Union"), CFG.BUTTON_HEIGHT * 3 / 5, true, true){
            ...
            protected void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                ...
                ImageManager.getImage(Images.diplo_message).draw(oSB, Menu_InGame_Message_Union.this.getPosX() + CFG.PADDING * 2 + iTranslateX, Menu_InGame_Message_Union.this.getPosY() - this.getHeight() / 2 - ImageManager.getImage(Images.diplo_message).getHeight() / 2);
