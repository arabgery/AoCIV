...
class Button_BotBar_ProvinceValue extends Button_BotBar {
   protected Button_BotBar_ProvinceValue(String sText, float FONT_SCALE, int iPosX, int iPosY, int iMinWidth, boolean isClickable, boolean isVisible) {
