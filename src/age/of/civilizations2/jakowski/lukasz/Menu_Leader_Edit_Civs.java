...
class Menu_Leader_Edit_Civs
extends SliderMenu {
    private List<Image> lFlags = new ArrayList<Image>();

    protected Menu_Leader_Edit_Civs() {
        ...
        this.initMenu(new SliderMenuTitle(null, CFG.BUTTON_HEIGHT * 3 / 4, false, false){
            ...
            protected void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                ImageManager.getImage(Images.new_game_top_edge_title).draw2(oSB, Menu_Leader_Edit_Civs.this.getPosX() - 2 + iTranslateX, Menu_Leader_Edit_Civs.this.getPosY() - ImageManager.getImage(Images.new_game_top_edge_title).getHeight() - this.getHeight(), Menu_Leader_Edit_Civs.this.getWidth() + 2, this.getHeight(), false, false);
                ...
                ImageManager.getImage(Images.gradient).draw(oSB, Menu_Leader_Edit_Civs.this.getPosX() + iTranslateX, Menu_Leader_Edit_Civs.this.getPosY() - ImageManager.getImage(Images.gradient).getHeight() - this.getHeight() * 3 / 4, Menu_Leader_Edit_Civs.this.getWidth(), this.getHeight() * 3 / 4, false, true);
                oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.65f));
                ImageManager.getImage(Images.gradient).draw(oSB, Menu_Leader_Edit_Civs.this.getPosX() + iTranslateX, Menu_Leader_Edit_Civs.this.getPosY() - ImageManager.getImage(Images.gradient).getHeight() - CFG.PADDING, Menu_Leader_Edit_Civs.this.getWidth(), CFG.PADDING, false, true);
                oSB.setColor(new Color(0.451f, 0.329f, 0.11f, 1.0f));
                ImageManager.getImage(Images.pix255_255_255).draw(oSB, Menu_Leader_Edit_Civs.this.getPosX() + iTranslateX, Menu_Leader_Edit_Civs.this.getPosY() - ImageManager.getImage(Images.pix255_255_255).getHeight(), Menu_Leader_Edit_Civs.this.getWidth());
                oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.9f));
                ImageManager.getImage(Images.line_32_off1).draw(oSB, Menu_Leader_Edit_Civs.this.getPosX() + iTranslateX, Menu_Leader_Edit_Civs.this.getPosY() - ImageManager.getImage(Images.pix255_255_255).getHeight() - ImageManager.getImage(Images.line_32_off1).getHeight(), Menu_Leader_Edit_Civs.this.getWidth(), 1);
