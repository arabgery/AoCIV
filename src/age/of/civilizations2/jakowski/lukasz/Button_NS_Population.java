...
class Button_NS_Population extends Button {
   ...
   protected Button_NS_Population(
      ...
      ImageManager.getImage(this.iImageID)
         .draw(
            ...
            this.getPosY()
               ...
               - (int)((float)ImageManager.getImage(this.iImageID).getHeight() * this.getImageScale(this.iImageID, 0.65F)) / 2
               - ImageManager.getImage(this.iImageID).getHeight()
               + iTranslateY,
            (int)((float)ImageManager.getImage(this.iImageID).getWidth() * this.getImageScale(this.iImageID, 0.65F)),
            (int)((float)ImageManager.getImage(this.iImageID).getHeight() * this.getImageScale(this.iImageID, 0.65F))
         );
