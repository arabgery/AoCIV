...
class Slider_Truce extends Slider_BG {
   private int iCivA = 0;

   protected Slider_Truce(int iCivA, int iCivB, int iPosX, int iPosY, int iWidth, int iHeight, int iMin, int iMax, int iCurrent) {
