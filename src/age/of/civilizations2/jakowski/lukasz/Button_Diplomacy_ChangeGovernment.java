...
class Button_Diplomacy_ChangeGovernment extends Button_Statistics {
      ...
      CFG.ideologiesManager
         ...
         .draw(
            ...
            this.getPosX()
               ...
               - (int)((float)CFG.ideologiesManager.getIdeology(this.iIdeologyID).getCrownImageScaled().getWidth() * this.getImageScale_Ideology()) / 2
               + CFG.PADDING * 3
               + (int)((float)ImageManager.getImage(Images.flag_rect).getWidth() * this.getImageScale(Images.flag_rect))
               + iTranslateX,
            this.getPosY()
               + this.getHeight() / 2
               - (int)((float)CFG.ideologiesManager.getIdeology(this.iIdeologyID).getCrownImageScaled().getHeight() * this.getImageScale_Ideology()) / 2
               - CFG.ideologiesManager.getIdeology(this.iIdeologyID).getCrownImageScaled().getHeight()
               + iTranslateY,
            (int)((float)CFG.ideologiesManager.getIdeology(this.iIdeologyID).getCrownImageScaled().getWidth() * this.getImageScale_Ideology()),
            (int)((float)CFG.ideologiesManager.getIdeology(this.iIdeologyID).getCrownImageScaled().getHeight() * this.getImageScale_Ideology())
         );
      oSB.setColor(Color.WHITE);
   ...
   private final float getImageScale_Ideology() {
      return (float)CFG.TEXT_HEIGHT / (float)CFG.ideologiesManager.getIdeology(this.iIdeologyID).getCrownImageScaled().getHeight() < 1.0F
         ? (float)CFG.TEXT_HEIGHT / (float)CFG.ideologiesManager.getIdeology(this.iIdeologyID).getCrownImageScaled().getHeight()
         : 1.0F;
   }
