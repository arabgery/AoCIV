...
class Menu_InGame_Message_UltimatumRefused
extends SliderMenu {
    ...
    protected Menu_InGame_Message_UltimatumRefused() {
    ...
    protected Menu_InGame_Message_UltimatumRefused(int onCivID, int iMessageID, int iValue) {
        ...
        menuElements.add(new Button_Diplomacy_Demands(CFG.langManager.get("RefusedToAcceptOurUltimatum"), onCivID, 2, tY += ((MenuElement)menuElements.get(menuElements.size() - 1)).getHeight(), CFG.BUTTON_WIDTH * 2){
        ...
        this.initMenu(new SliderMenuTitle(CFG.langManager.get("RefusedUltimatum"), CFG.BUTTON_HEIGHT * 3 / 5, true, true){
            ...
            protected void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                ...
                ImageManager.getImage(Images.diplo_message).draw(oSB, Menu_InGame_Message_UltimatumRefused.this.getPosX() + CFG.PADDING * 2 + iTranslateX, Menu_InGame_Message_UltimatumRefused.this.getPosY() - this.getHeight() / 2 - ImageManager.getImage(Images.diplo_message).getHeight() / 2);
                CFG.fontMain.getData().setScale(0.8f);
