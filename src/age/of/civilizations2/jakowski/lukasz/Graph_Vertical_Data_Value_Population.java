...
class Graph_Vertical_Data_Value_Population extends Graph_Vertical_Data_Value {
   protected Graph_Vertical_Data_Value_Population(int iValue, int iColorDataID) {
