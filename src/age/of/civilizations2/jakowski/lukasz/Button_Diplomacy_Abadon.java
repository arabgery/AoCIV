...
class Button_Diplomacy_Abadon extends Button_Statistics {
   ...
   protected Button_Diplomacy_Abadon(String sText, String nDiploCost, int nAggressor, int nProvinceID, int iPosX, int iPosY, int iWidth) {
