    ...
    protected Menu_InGame_Destroy_Supply(int nProvinceID) {
        ...
        menuElements.add(new Button_Build_Building_Destroy(CFG.game.getProvince(this.iProvinceID).getName().length() > 0 ? CFG.game.getProvince(this.iProvinceID).getName() : CFG.langManager.get("Province"), CFG.langManager.get("Destroy") + ": " + CFG.langManager.get(BuildingsManager.getSupply_Name(CFG.game.getProvince(this.iProvinceID).getLevelOfSupply())), Images.b_supply, 0, tY, CFG.BUTTON_WIDTH * 2, true){
            ...
            protected void buildElementHover() {
                ...
                nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get(BuildingsManager.getSupply_Name(CFG.game.getProvince(Menu_InGame_Destroy_Supply.this.iProvinceID).getLevelOfSupply())) + ": ", CFG.COLOR_TEXT_NUM_OF_PROVINCES));
                nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.game.getProvince(Menu_InGame_Destroy_Supply.this.iProvinceID).getName().length() > 0 ? CFG.game.getProvince(Menu_InGame_Destroy_Supply.this.iProvinceID).getName() : CFG.langManager.get("Province")));
                nData.add(new MenuElement_Hover_v2_Element_Type_Flag(CFG.game.getProvince(Menu_InGame_Destroy_Supply.this.iProvinceID).getCivID(), CFG.PADDING, 0));
                ...
                nData.add(new MenuElement_Hover_v2_Element_Type_Text("-" + (int)(BuildingsManager.getSupply_Bonus(CFG.game.getProvince(Menu_InGame_Destroy_Supply.this.iProvinceID).getLevelOfSupply()) * 100.0f) + "%", CFG.COLOR_TEXT_MODIFIER_POSITIVE));
                nElements.add(new MenuElement_Hover_v2_Element2(nData));
                nData.clear();
        ...
        this.initMenu(new SliderMenuTitle(CFG.langManager.get(BuildingsManager.getSupply_Name(CFG.game.getProvince(this.iProvinceID).getLevelOfSupply())), CFG.BUTTON_HEIGHT * 3 / 5, true, true){
            ...
            protected void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                ...
                CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getFlag().draw(oSB, Menu_InGame_Destroy_Supply.this.getPosX() + CFG.PADDING * 2 + iTranslateX, Menu_InGame_Destroy_Supply.this.getPosY() - this.getHeight() / 2 - CFG.CIV_FLAG_HEIGHT / 2 - CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getFlag().getHeight(), CFG.CIV_FLAG_WIDTH, CFG.CIV_FLAG_HEIGHT);
                ImageManager.getImage(Images.flag_rect).draw(oSB, Menu_InGame_Destroy_Supply.this.getPosX() + CFG.PADDING * 2 + iTranslateX, Menu_InGame_Destroy_Supply.this.getPosY() - this.getHeight() / 2 - CFG.CIV_FLAG_HEIGHT / 2);
                CFG.fontMain.getData().setScale(0.8f);
