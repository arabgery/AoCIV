...
class Button_Game_PLAY extends Button_Game {
   ...
   protected Button_Game_PLAY(String sText, int iTextPositionX, int iPosX, int iPosY, int nWidth, boolean isClickable) {
