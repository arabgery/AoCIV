...
class Button_Diplomacy_Relation extends Button_Statistics {
   ...
   protected Button_Diplomacy_Relation(String sText, String nDiploCost, int nAggressor, int nDefender, int iPosX, int iPosY, int iWidth) {
   ...
   protected void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      ImageManager.getImage(Images.pix255_255_255)
         .draw(
            oSB,
            this.getPosX() + this.iCurrentRelationWidth + CFG.PADDING * 3 + (int)((float)this.getTextWidth() * 0.7F) + iTranslateX,
            this.getPosY()
               + this.getHeight() / 2
      ...
      CFG.game
         ...
         .draw(
            oSB,
            this.getPosX() + this.iCurrentRelationWidth + CFG.PADDING * 3 + (int)((float)this.getTextWidth() * 0.7F) + 2 + iTranslateX,
            this.getPosY()
               + this.getHeight() / 2
               - (int)((float)ImageManager.getImage(Images.flag_rect).getHeight() * this.getImageScale(Images.flag_rect)) / 2
