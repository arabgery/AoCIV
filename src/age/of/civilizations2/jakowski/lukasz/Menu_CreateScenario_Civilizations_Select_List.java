...
class Menu_CreateScenario_Civilizations_Select_List
extends SliderMenu {
    ...
    protected Menu_CreateScenario_Civilizations_Select_List() {
                ...
                menuElements.add(new Button_Menu_Classic_Wiki(tID++, CFG.GAME_WIDTH - (CFG.BUTTON_WIDTH + CFG.BUTTON_WIDTH / 2), CFG.BUTTON_HEIGHT * nPosY + CFG.PADDING * (nPosY + 1), CFG.BUTTON_WIDTH + CFG.BUTTON_WIDTH / 2, CFG.BUTTON_HEIGHT, true){
                    ...
                    protected void buildElementHover() {
                        try {
                            ...
                            nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.getWikiInormationsLink_Clear((String)Menu_CreateScenario_Civilizations_Select_List.this.lCivsTags.get(this.getTextPos())), CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE));
    ...
    protected void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean sliderMenuIsActive) {
        ...
        try {
            for (int i = tempRandomButton; i < this.getMenuElementsSize(); i += 2) {
                ...
                this.lFlags.get(this.getFlagID((i - tempRandomButton) / 2)).draw(oSB, this.getMenuElement(i).getPosX() + this.getMenuElement(i).getTextPos() / 2 - CFG.CIV_FLAG_WIDTH / 2 + iTranslateX, this.getMenuElement(i).getPosY() - this.lFlags.get(this.getFlagID((i - tempRandomButton) / 2)).getHeight() + this.getMenuPosY() + this.getMenuElement(i).getHeight() / 2 - CFG.CIV_FLAG_HEIGHT / 2 + iTranslateY, CFG.CIV_FLAG_WIDTH, CFG.CIV_FLAG_HEIGHT);
        ...
        switch (iID) {
            case 0: {
                ...
                for (int i = 1; i < CFG.game.getCivsSize() - 1; ++i) {
                    if (!CFG.game.getCiv(i).getCivTag().equals("ran")) continue;
                    ++iRandomCivID;
                }
