...
class Button_Diplomacy_Action extends Button {
   private int iImageID = 0;
   private boolean row = false;

   protected Button_Diplomacy_Action(int nImageID, String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight, boolean isClickable) {
