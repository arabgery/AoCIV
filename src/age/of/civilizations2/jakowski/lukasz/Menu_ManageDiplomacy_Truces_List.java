...
import age.of.civilizations2.jakowski.lukasz.Slider_Truce;
...
extends SliderMenu {
    protected Menu_ManageDiplomacy_Truces_List() {
        ...
        if (CFG.MANAGE_DIPLOMACY_CUSTOMIZE_ALLIANCE_ID > 0) {
            ...
            for (int i = 1; i < CFG.game.getCivsSize(); ++i) {
                if (i == CFG.MANAGE_DIPLOMACY_CUSTOMIZE_ALLIANCE_ID || CFG.game.getCivTruce(i, CFG.MANAGE_DIPLOMACY_CUSTOMIZE_ALLIANCE_ID) <= 0) continue;
                menuElements.add(new Slider_Truce(i, CFG.MANAGE_DIPLOMACY_CUSTOMIZE_ALLIANCE_ID, CFG.PADDING, CFG.PADDING * (multiplePosY + 1) + CFG.BUTTON_HEIGHT * multiplePosY + CFG.PADDING, tempW - CFG.BUTTON_HEIGHT * 3 / 4 - CFG.PADDING * 2, CFG.BUTTON_HEIGHT - CFG.PADDING * 2, 1, 40, CFG.game.getCivTruce(i, CFG.MANAGE_DIPLOMACY_CUSTOMIZE_ALLIANCE_ID)));
        ...
        this.initMenu(new SliderMenuTitle(null, CFG.BUTTON_HEIGHT * 3 / 4, false, false){
            ...
            protected void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                ImageManager.getImage(Images.new_game_top_edge_title).draw2(oSB, Menu_ManageDiplomacy_Truces_List.this.getPosX() + iTranslateX, Menu_ManageDiplomacy_Truces_List.this.getPosY() - ImageManager.getImage(Images.new_game_top_edge_title).getHeight() - this.getHeight(), Menu_ManageDiplomacy_Truces_List.this.getWidth() + 2, this.getHeight(), true, false);
                oSB.setColor(new Color(0.011f, 0.014f, 0.019f, 0.25f));
                ImageManager.getImage(Images.gradient).draw(oSB, Menu_ManageDiplomacy_Truces_List.this.getPosX() + iTranslateX, Menu_ManageDiplomacy_Truces_List.this.getPosY() - ImageManager.getImage(Images.gradient).getHeight() - this.getHeight() * 3 / 4, Menu_ManageDiplomacy_Truces_List.this.getWidth(), this.getHeight() * 3 / 4, false, true);
                oSB.setColor(new Color(0.451f, 0.329f, 0.11f, 1.0f));
                ImageManager.getImage(Images.pix255_255_255).draw(oSB, Menu_ManageDiplomacy_Truces_List.this.getPosX() + iTranslateX, Menu_ManageDiplomacy_Truces_List.this.getPosY() - ImageManager.getImage(Images.pix255_255_255).getHeight(), Menu_ManageDiplomacy_Truces_List.this.getWidth());
                oSB.setColor(new Color(CFG.COLOR_FLAG_FRAME.r, CFG.COLOR_FLAG_FRAME.g, CFG.COLOR_FLAG_FRAME.b, 0.4f));
                ImageManager.getImage(Images.line_32_off1).draw(oSB, Menu_ManageDiplomacy_Truces_List.this.getPosX() + iTranslateX, Menu_ManageDiplomacy_Truces_List.this.getPosY() - ImageManager.getImage(Images.pix255_255_255).getHeight() - ImageManager.getImage(Images.line_32_off1).getHeight(), Menu_ManageDiplomacy_Truces_List.this.getWidth(), 1);
