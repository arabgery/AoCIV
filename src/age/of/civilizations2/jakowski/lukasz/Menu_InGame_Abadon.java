...
import age.of.civilizations2.jakowski.lukasz.Button_Diplomacy_Abadon;
...
extends SliderMenu {
    ...
    protected Menu_InGame_Abadon(int onCivID, int nProvinceID) {
        ArrayList<MenuElement> menuElements = new ArrayList<MenuElement>();
        this.iOnCivID = onCivID;
        iProvinceID = nProvinceID;
        int tempWidth = CFG.CIV_INFO_MENU_WIDTH * 2;
        int tY = 0;
        menuElements.add(new Button_Diplomacy_Abadon(CFG.langManager.get("Abandon") + ": ", "0.0", CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), nProvinceID, 2, tY, CFG.BUTTON_WIDTH * 2){
        ...
        menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Confirm"), -1, 2, tY, CFG.BUTTON_WIDTH, true){
            ...
            protected void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
                ...
                CFG.drawText(oSB, this.getText(), this.getPosX() + this.getWidth() / 2 - (int)((double)this.getTextWidth() * 0.8 / 2.0) + iTranslateX, this.getPosY() + this.getHeight() / 2 - (int)((float)this.getTextHeight() * 0.8f / 2.0f) + iTranslateY, this.getColor(isActive));
        ...
        int tempMenuPosY = ImageManager.getImage(Images.top_left2).getHeight() + CFG.PADDING * 2 + CFG.BUTTON_HEIGHT * 3 / 5;
        this.initMenu(new SliderMenuTitle(CFG.langManager.get("AbandonProvince"), CFG.BUTTON_HEIGHT * 3 / 5, true, true){
