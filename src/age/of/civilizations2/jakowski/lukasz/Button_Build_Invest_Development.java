...
public class Button_Build_Invest_Development extends Button_Build {
   ...
   protected Button_Build_Invest_Development(String sText, String sProvinceID, int nImageID, int nCost, int nMovementCost, int iPosX, int iPosY, int iWidth) {
   ...
   protected void setMin(int iMin) {
      float nMin = (float)iMin / 10000.0F;
