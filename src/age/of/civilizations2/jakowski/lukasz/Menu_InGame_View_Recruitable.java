...
import age.of.civilizations2.jakowski.lukasz.Button_View_Recruitable;
...
class Menu_InGame_View_Recruitable
extends SliderMenu {
    ...
    protected Menu_InGame_View_Recruitable() {
        int i;
        ...
        while (tempProvs.size() > 0) {
            ...
            for (int i2 = 1; i2 < tempProvs.size(); ++i2) {
                if (CFG.gameAction.getRecruitableArmy((Integer)tempProvs.get(tBest), this.iCivID) >= CFG.gameAction.getRecruitableArmy((Integer)tempProvs.get(i2), this.iCivID)) continue;
                tBest = i2;
            }
        ...
        this.initMenu(new SliderMenuTitle(CFG.game.getCiv(this.iCivID).getCivName(), CFG.BUTTON_HEIGHT * 3 / 5, false, false){
            ...
            protected void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                ImageManager.getImage(Images.new_game_top_edge_title).draw2(oSB, Menu_InGame_View_Recruitable.this.getPosX() + iTranslateX, Menu_InGame_View_Recruitable.this.getPosY() - ImageManager.getImage(Images.new_game_top_edge_title).getHeight() - this.getHeight(), Menu_InGame_View_Recruitable.this.getWidth() + 2, this.getHeight(), true, false);
                ...
                ImageManager.getImage(Images.pix255_255_255).draw(oSB, Menu_InGame_View_Recruitable.this.getPosX() + iTranslateX, Menu_InGame_View_Recruitable.this.getPosY() - ImageManager.getImage(Images.pix255_255_255).getHeight(), Menu_InGame_View_Recruitable.this.getWidth());
                oSB.setColor(new Color(CFG.COLOR_FLAG_FRAME.r, CFG.COLOR_FLAG_FRAME.g, CFG.COLOR_FLAG_FRAME.b, 0.4f));
                ImageManager.getImage(Images.line_32_off1).draw(oSB, Menu_InGame_View_Recruitable.this.getPosX() + iTranslateX, Menu_InGame_View_Recruitable.this.getPosY() - ImageManager.getImage(Images.pix255_255_255).getHeight() - ImageManager.getImage(Images.line_32_off1).getHeight(), Menu_InGame_View_Recruitable.this.getWidth(), 1);
                oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.6f));
                ImageManager.getImage(Images.line_32_off1).draw(oSB, Menu_InGame_View_Recruitable.this.getPosX() + iTranslateX, Menu_InGame_View_Recruitable.this.getPosY() - ImageManager.getImage(Images.pix255_255_255).getHeight() - ImageManager.getImage(Images.line_32_off1).getHeight() - 1, Menu_InGame_View_Recruitable.this.getWidth(), 1);
                oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.8f));
                ImageManager.getImage(Images.slider_gradient).draw(oSB, Menu_InGame_View_Recruitable.this.getPosX() + iTranslateX, Menu_InGame_View_Recruitable.this.getPosY() - ImageManager.getImage(Images.pix255_255_255).getHeight() - ImageManager.getImage(Images.slider_gradient).getHeight(), Menu_InGame_View_Recruitable.this.getWidth() / 4, 1);
                ImageManager.getImage(Images.slider_gradient).draw(oSB, Menu_InGame_View_Recruitable.this.getPosX() + Menu_InGame_View_Recruitable.this.getWidth() - Menu_InGame_View_Recruitable.this.getWidth() / 4 + iTranslateX, Menu_InGame_View_Recruitable.this.getPosY() - ImageManager.getImage(Images.pix255_255_255).getHeight() - ImageManager.getImage(Images.slider_gradient).getHeight(), Menu_InGame_View_Recruitable.this.getWidth() / 4, 1, true, false);
                oSB.setColor(Color.WHITE);
                ImageManager.getImage(Images.diplo_army).draw(oSB, nPosX + CFG.PADDING * 2 + iTranslateX, Menu_InGame_View_Recruitable.this.getPosY() - this.getHeight() / 2 - ImageManager.getImage(Images.diplo_army).getHeight() / 2);
