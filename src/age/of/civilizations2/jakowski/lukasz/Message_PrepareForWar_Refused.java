...
class Message_PrepareForWar_Refused extends Message {
   protected Message_PrepareForWar_Refused(int fromCivID, int iValue) {
   ...
   protected MenuElement_Hover_v2 getHover() {
      ...
      nData.add(
         new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("RefusedToJoinWarPreparationsAgainst") + ":", CFG.COLOR_TEXT_MODIFIER_NEGATIVE2)
      );
