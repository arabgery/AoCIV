...
class Button_Statistics_Flag_Clip extends Button_Statistics_Flag {
   protected Button_Statistics_Flag_Clip(int iCivID, String sText, int iTextPosX, int iPosX, int iPosY, int iWidth, int iHeight) {
