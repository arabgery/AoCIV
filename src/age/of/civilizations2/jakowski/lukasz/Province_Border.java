...
class Province_Border {
   ...
   protected Province_Border.DrawProvince_Border drawProvince_Border;
   public List<Short> lPointsX = new ArrayList<>();
   public List<Short> lPointsY = new ArrayList<>();

   protected Province_Border(int withProvinceID, List<Short> nPointsX, List<Short> nPointsY) {
      int i = 0;
      ...
      for(int ix = 0; ix < this.iProvinceBorderLineSize; ++ix) {
         this.iLineWidth += this.provinceBorderLine.get(ix).getWidth();
      }
   }
            ...
            public void draw(SpriteBatch oSB, int nTranslateProvincePosX) {
               oSB.setColor(
                  new Color(
                     ...
                     (float)CFG.game.getProvinceAnimation_Active_Data().getBorderAlpha() / 255.0F
                  )
               );
               Province_Border.this.drawStraightBorder(oSB, nTranslateProvincePosX);
            }
         ...
         this.drawProvince_Border = new Province_Border.DrawProvince_Border() {
            ...
            public void draw(SpriteBatch oSB, int nTranslateProvincePosX) {
               Province_Border.this.drawDashedBorder_PercentageWidth_Full_Straight(
                  ...
                  (100.0F - CFG.game.fDashedLine_Percentage_HighlitedProvinceBorder) / 100.0F,
                  nTranslateProvincePosX,
                  new Color(0.9411765F, 0.7529412F, 0.15294118F, (float)CFG.game.getProvinceAnimation_Active_Data().getBorderAlpha() / 255.0F),
            ...
            public void draw(SpriteBatch oSB, int nTranslateProvincePosX) {
               oSB.setColor(
                  new Color(
                     ...
                     (float)CFG.game.getProvinceAnimation_Active_Data().getBorderAlpha() / 255.0F * 0.6F
                        + (float)CFG.game.getProvinceAnimation_Active_Data().getBorderAlpha()
                           / 255.0F
                           * 0.4F
   ...
   protected final void drawDashedBorder_PercentageWidth_Full_Straight(
      ...
      for(int i = 0; i < this.iProvinceBorderLineSize && currentWidth <= lineWidth; ++i) {
   ...
   protected final void drawStraightBorder_PercentageWidth_Full_Straight(
   ...
   protected final void drawDashedBorder_PercentageWidth_Full_Straight(
      ...
      while(iBeginDraw_ID < this.iProvinceBorderLineSize) {
         ImageManager.getImage(nImageIDActive)
            .draw(
               ...
               CFG.map.getMapCoordinates().getPosY()
                  + this.provinceBorderLine.get(iBeginDraw_ID).getPosY()
                  - ImageManager.getImage(nImageIDActive).getHeight(),
               this.provinceBorderLine.get(iBeginDraw_ID).getWidth(),
      ...
      for(int i = 0; i < this.iProvinceBorderLineSize && currentWidth <= lineWidth && i < iBeginDraw_ID; ++i) {
         ImageManager.getImage(nImageIDOld)
            .draw(
               oSB,
               nTranslateProvincePosX + this.provinceBorderLine.get(i).getPosX(),
               CFG.map.getMapCoordinates().getPosY() + this.provinceBorderLine.get(i).getPosY() - ImageManager.getImage(nImageIDOld).getHeight(),
               currentWidth + this.provinceBorderLine.get(i).getWidth() <= lineWidth ? this.provinceBorderLine.get(i).getWidth() : lineWidth - currentWidth,
   ...
   protected final void drawStraightBorder_PercentageWidth_Full_Dashed(
      SpriteBatch oSB, float fPercent, int nTranslateProvincePosX, Color activeColor, Color oldColor
   ) {
      int lineWidth = (int)((float)this.iLineWidth * fPercent);
      int iBeginDraw_ID = 0;
   ...
   protected final void drawDashedBorder_PercentageWidth_Full_SeaBySea(
