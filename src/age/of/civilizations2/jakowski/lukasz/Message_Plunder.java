...
class Message_Plunder extends Message {
   ...
   protected Message_Plunder(int fromCivID, int iValue, int iTreasury, int iEconomy, float fDevelopment, float fHappiness, int iPopulation) {
