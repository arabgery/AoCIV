...
import age.of.civilizations2.jakowski.lukasz.Button_Diplomacy_Civilize2;
...
class Menu_InGame_Civilize
extends SliderMenu {
    private int iOnCivID = -1;

    protected Menu_InGame_Civilize() {
    ...
    protected Menu_InGame_Civilize(final int onCivID) {
        ...
        menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Civilize"), -1, 2, tY, CFG.BUTTON_WIDTH, true){
            ...
            protected void buildElementHover() {
                try {
                    ...
                    nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.ideologiesManager.getIdeology(CFG.ideologiesManager.getIdeology((int)CFG.game.getCiv((int)onCivID).getIdeologyID()).CAN_BECOME_CIVILIZED).getName(), CFG.ideologiesManager.getIdeology(CFG.ideologiesManager.getIdeology((int)CFG.game.getCiv((int)onCivID).getIdeologyID()).CAN_BECOME_CIVILIZED).getColor()));
                    nData.add(new MenuElement_Hover_v2_Element_Type_Ideology(CFG.ideologiesManager.getIdeology((int)CFG.game.getCiv((int)onCivID).getIdeologyID()).CAN_BECOME_CIVILIZED, CFG.PADDING, 0));
                    nElements.add(new MenuElement_Hover_v2_Element2(nData));
                    nData.clear();
                    ...
                    nData.add(new MenuElement_Hover_v2_Element_Type_Text("" + (float)((int)(CFG.ideologiesManager.getIdeology((int)CFG.game.getCiv((int)onCivID).getIdeologyID()).CIVILIZE_TECH_LEVEL * 100.0f)) / 100.0f, CFG.COLOR_TEXT_TECHNOLOGY));
                    nData.add(new MenuElement_Hover_v2_Element_Type_Image(Images.technology, CFG.PADDING, 0));
                    nData.add(new MenuElement_Hover_v2_Element_Type_Image(CFG.game.getCiv(onCivID).getTechnologyLevel() >= CFG.ideologiesManager.getIdeology((int)CFG.game.getCiv((int)onCivID).getIdeologyID()).CIVILIZE_TECH_LEVEL ? Images.icon_check_true : Images.icon_check_false, CFG.PADDING, CFG.PADDING));
                    nData.add(new MenuElement_Hover_v2_Element_Type_Text("[", CFG.game.getCiv(onCivID).getTechnologyLevel() >= CFG.ideologiesManager.getIdeology((int)CFG.game.getCiv((int)onCivID).getIdeologyID()).CIVILIZE_TECH_LEVEL ? CFG.COLOR_TEXT_MODIFIER_POSITIVE : CFG.COLOR_TEXT_MODIFIER_NEGATIVE2));
                    nData.add(new MenuElement_Hover_v2_Element_Type_Flag(onCivID, 0, CFG.PADDING));
                    nData.add(new MenuElement_Hover_v2_Element_Type_Text("" + (float)((int)(CFG.game.getCiv(onCivID).getTechnologyLevel() * 100.0f)) / 100.0f, CFG.game.getCiv(onCivID).getTechnologyLevel() >= CFG.ideologiesManager.getIdeology((int)CFG.game.getCiv((int)onCivID).getIdeologyID()).CIVILIZE_TECH_LEVEL ? CFG.COLOR_TEXT_MODIFIER_POSITIVE : CFG.COLOR_TEXT_MODIFIER_NEGATIVE2));
                    nData.add(new MenuElement_Hover_v2_Element_Type_Image(Images.technology, CFG.PADDING, 0));
                    nData.add(new MenuElement_Hover_v2_Element_Type_Text("]", CFG.game.getCiv(onCivID).getTechnologyLevel() >= CFG.ideologiesManager.getIdeology((int)CFG.game.getCiv((int)onCivID).getIdeologyID()).CIVILIZE_TECH_LEVEL ? CFG.COLOR_TEXT_MODIFIER_POSITIVE : CFG.COLOR_TEXT_MODIFIER_NEGATIVE2));
                    nElements.add(new MenuElement_Hover_v2_Element2(nData));
                    nData.clear();
                    ...
                    nData.add(new MenuElement_Hover_v2_Element_Type_Image(CFG.game.getCiv(onCivID).getDiplomacyPoints() >= 10 ? Images.icon_check_true : Images.icon_check_false, CFG.PADDING, 0));
                    nElements.add(new MenuElement_Hover_v2_Element2(nData));
                    nData.clear();
            ...
            protected void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
                try {
                    CFG.ideologiesManager.getIdeology(CFG.ideologiesManager.getIdeology((int)CFG.game.getCiv((int)((Menu_InGame_Civilize)Menu_InGame_Civilize.this).iOnCivID).getIdeologyID()).CAN_BECOME_CIVILIZED).getCrownImageScaled().draw(oSB, this.getPosX() + this.getWidth() / 2 - (int)(((float)this.getTextWidth() * 0.8f + (float)CFG.ideologiesManager.getIdeology(CFG.ideologiesManager.getIdeology((int)CFG.game.getCiv((int)((Menu_InGame_Civilize)Menu_InGame_Civilize.this).iOnCivID).getIdeologyID()).CAN_BECOME_CIVILIZED).getCrownImageScaled().getWidth() + (float)CFG.PADDING) / 2.0f) + iTranslateX, this.getPosY() + this.getHeight() / 2 - CFG.ideologiesManager.getIdeology(CFG.ideologiesManager.getIdeology((int)CFG.game.getCiv((int)((Menu_InGame_Civilize)Menu_InGame_Civilize.this).iOnCivID).getIdeologyID()).CAN_BECOME_CIVILIZED).getCrownImageScaled().getHeight() / 2 + iTranslateY);
                    CFG.fontMain.getData().setScale(0.8f);
                    CFG.drawText(oSB, this.getText(), this.getPosX() + (this.getTextPos() < 0 ? this.getWidth() / 2 - (int)(((float)this.getTextWidth() * 0.8f + (float)CFG.ideologiesManager.getIdeology(CFG.ideologiesManager.getIdeology((int)CFG.game.getCiv((int)((Menu_InGame_Civilize)Menu_InGame_Civilize.this).iOnCivID).getIdeologyID()).CAN_BECOME_CIVILIZED).getCrownImageScaled().getWidth() + (float)CFG.PADDING) / 2.0f) + CFG.ideologiesManager.getIdeology(CFG.ideologiesManager.getIdeology((int)CFG.game.getCiv((int)((Menu_InGame_Civilize)Menu_InGame_Civilize.this).iOnCivID).getIdeologyID()).CAN_BECOME_CIVILIZED).getCrownImageScaled().getWidth() + CFG.PADDING : this.getTextPos()) + iTranslateX, this.getPosY() + this.getHeight() / 2 - (int)((float)this.getTextHeight() * 0.8f / 2.0f) + iTranslateY, this.getColor(isActive));
            ...
            protected boolean getClickable() {
                return CFG.game.getCiv(Menu_InGame_Civilize.this.iOnCivID).getDiplomacyPoints() >= 10 && CFG.ideologiesManager.getIdeology((int)CFG.game.getCiv((int)((Menu_InGame_Civilize)Menu_InGame_Civilize.this).iOnCivID).getIdeologyID()).CIVILIZE_TECH_LEVEL <= CFG.game.getCiv(Menu_InGame_Civilize.this.iOnCivID).getTechnologyLevel();
            }
        ...
        int tempMenuPosY = ImageManager.getImage(Images.top_left2).getHeight() + CFG.PADDING * 2 + CFG.BUTTON_HEIGHT * 3 / 5;
        this.initMenu(new SliderMenuTitle(CFG.langManager.get("Civilize"), CFG.BUTTON_HEIGHT * 3 / 5, true, true){
            ...
            protected void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                ...
                CFG.ideologiesManager.getIdeology(CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getIdeologyID()).getCrownImageScaled().draw(oSB, Menu_InGame_Civilize.this.getPosX() + CFG.PADDING * 2 + iTranslateX, Menu_InGame_Civilize.this.getPosY() - this.getHeight() / 2 - CFG.ideologiesManager.getIdeology(CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getIdeologyID()).getCrownImageScaled().getHeight() / 2);
                CFG.fontMain.getData().setScale(0.8f);
    ...
    protected final void actionElement(int iID) {
        if (iID == this.getMenuElementsSize() - 1) {
            if (DiplomacyManager.civilizeCiv(this.iOnCivID)) {
                for (int i = 0; i < CFG.game.getCiv((int)this.iOnCivID).getCivilization_Diplomacy_GameData().messageBox.getMessagesSize(); ++i) {
                    if (CFG.game.getCiv((int)this.iOnCivID).getCivilization_Diplomacy_GameData().messageBox.getMessage((int)i).messageType != Message_Type.UNCIVILIZED) continue;
                    CFG.game.getCiv((int)this.iOnCivID).getCivilization_Diplomacy_GameData().messageBox.removeMessage(i);
                    break;
                }
