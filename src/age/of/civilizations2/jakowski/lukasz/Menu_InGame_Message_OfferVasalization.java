...
class Menu_InGame_Message_OfferVasalization
extends SliderMenu {
    ...
    protected Menu_InGame_Message_OfferVasalization() {
    ...
    protected Menu_InGame_Message_OfferVasalization(int onCivID, int iMessageID, int iValue) {
        ...
        this.initMenu(new SliderMenuTitle(CFG.langManager.get("Vassal"), CFG.BUTTON_HEIGHT * 3 / 5, true, true){
            ...
            protected void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                ...
                ImageManager.getImage(Images.diplo_message).draw(oSB, Menu_InGame_Message_OfferVasalization.this.getPosX() + CFG.PADDING * 2 + iTranslateX, Menu_InGame_Message_OfferVasalization.this.getPosY() - this.getHeight() / 2 - ImageManager.getImage(Images.diplo_message).getHeight() / 2);
