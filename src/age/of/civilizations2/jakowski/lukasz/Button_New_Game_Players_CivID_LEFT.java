...
class Button_New_Game_Players_CivID_LEFT extends Button_New_Game_Players {
   private int iCivID = 0;

   protected Button_New_Game_Players_CivID_LEFT(int iCivID, String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, boolean isClickable) {
