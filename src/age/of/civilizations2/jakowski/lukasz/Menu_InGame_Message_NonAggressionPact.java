...
class Menu_InGame_Message_NonAggressionPact
extends SliderMenu {
    ...
    protected Menu_InGame_Message_NonAggressionPact() {
    ...
    protected Menu_InGame_Message_NonAggressionPact(int onCivID, int iMessageID, int iValue) {
        ArrayList<MenuElement> menuElements = new ArrayList<MenuElement>();
        this.iOnCivID = onCivID;
        this.iMessageID = iMessageID;
        int tempWidth = CFG.CIV_INFO_MENU_WIDTH * 2;
        int tY = 0;
        menuElements.add(new Button_Diplomacy_Message_Pact(Images.diplo_non_aggression, CFG.langManager.get("SignNonAggressionPactWithCivA", CFG.game.getCiv(this.iOnCivID).getCivName()), this.iOnCivID, CFG.langManager.get("TurnsX", iValue), 2, tY, CFG.BUTTON_WIDTH * 2){
        ...
        this.initMenu(new SliderMenuTitle(CFG.langManager.get("NonAggressionPact"), CFG.BUTTON_HEIGHT * 3 / 5, true, true){
            ...
            protected void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                ...
                ImageManager.getImage(Images.diplo_message).draw(oSB, Menu_InGame_Message_NonAggressionPact.this.getPosX() + CFG.PADDING * 2 + iTranslateX, Menu_InGame_Message_NonAggressionPact.this.getPosY() - this.getHeight() / 2 - ImageManager.getImage(Images.diplo_message).getHeight() / 2);
