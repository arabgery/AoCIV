...
class Button_Diplomacy_Action_Tech extends Button {
   ...
   protected Button_Diplomacy_Action_Tech(int nImageID, String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight, boolean isClickable) {
