...
import age.of.civilizations2.jakowski.lukasz.Button_View_ProvinceValue;
...
class Menu_InGame_View_ProvinceValue
extends SliderMenu {
    ...
    protected Menu_InGame_View_ProvinceValue(int init) {
    ...
    protected Menu_InGame_View_ProvinceValue() {
        ...
        while (tempProvs.size() > 0) {
            ...
            for (int i2 = 1; i2 < tempProvs.size(); ++i2) {
                if (CFG.game.getProvinceValue((Integer)tempProvs.get(tBest)) >= CFG.game.getProvinceValue((Integer)tempProvs.get(i2))) continue;
                tBest = i2;
            }
        ...
        if (tempProvincesSorted.size() > 0) {
            menuElements.add(new Button_NS_Population(new Color((float)CFG.game.getCiv(this.iCivID).getR() / 255.0f, (float)CFG.game.getCiv(this.iCivID).getG() / 255.0f, (float)CFG.game.getCiv(this.iCivID).getB() / 255.0f, 1.0f), CFG.game.getCiv(this.iCivID).getCivName(), this.iCivID, CFG.langManager.get("Provinces") + ": ", CFG.getNumberWithSpaces("" + totalPopulation), Images.victoryPoints, CFG.COLOR_TEXT_PROVINCE_VALUE, 0, tY, tempW){});
            tY += ((MenuElement)menuElements.get(menuElements.size() - 1)).getHeight();
            for (i = 0; i < tempProvincesSorted.size(); ++i) {
                menuElements.add(new Button_View_ProvinceValue(i, (CFG.game.getProvince((Integer)tempProvincesSorted.get(i)).getName().length() > 0 ? CFG.game.getProvince((Integer)tempProvincesSorted.get(i)).getName() : CFG.game.getCiv(this.iCivID).getCivName()) + ": ", (Integer)tempProvincesSorted.get(i), totalPopulation, 0, tY, CFG.CIV_INFO_MENU_WIDTH, false){
        ...
        this.initMenu(new SliderMenuTitle(CFG.game.getCiv(this.iCivID).getCivName(), CFG.BUTTON_HEIGHT * 3 / 5, false, false){
            ...
            protected void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                ImageManager.getImage(Images.new_game_top_edge_title).draw2(oSB, Menu_InGame_View_ProvinceValue.this.getPosX() + iTranslateX, Menu_InGame_View_ProvinceValue.this.getPosY() - ImageManager.getImage(Images.new_game_top_edge_title).getHeight() - this.getHeight(), Menu_InGame_View_ProvinceValue.this.getWidth() + 2, this.getHeight(), true, false);
                ...
                ImageManager.getImage(Images.pix255_255_255).draw(oSB, Menu_InGame_View_ProvinceValue.this.getPosX() + iTranslateX, Menu_InGame_View_ProvinceValue.this.getPosY() - ImageManager.getImage(Images.pix255_255_255).getHeight(), Menu_InGame_View_ProvinceValue.this.getWidth());
                oSB.setColor(new Color(CFG.COLOR_FLAG_FRAME.r, CFG.COLOR_FLAG_FRAME.g, CFG.COLOR_FLAG_FRAME.b, 0.4f));
                ImageManager.getImage(Images.line_32_off1).draw(oSB, Menu_InGame_View_ProvinceValue.this.getPosX() + iTranslateX, Menu_InGame_View_ProvinceValue.this.getPosY() - ImageManager.getImage(Images.pix255_255_255).getHeight() - ImageManager.getImage(Images.line_32_off1).getHeight(), Menu_InGame_View_ProvinceValue.this.getWidth(), 1);
                oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.6f));
                ImageManager.getImage(Images.line_32_off1).draw(oSB, Menu_InGame_View_ProvinceValue.this.getPosX() + iTranslateX, Menu_InGame_View_ProvinceValue.this.getPosY() - ImageManager.getImage(Images.pix255_255_255).getHeight() - ImageManager.getImage(Images.line_32_off1).getHeight() - 1, Menu_InGame_View_ProvinceValue.this.getWidth(), 1);
                oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.8f));
                ImageManager.getImage(Images.slider_gradient).draw(oSB, Menu_InGame_View_ProvinceValue.this.getPosX() + iTranslateX, Menu_InGame_View_ProvinceValue.this.getPosY() - ImageManager.getImage(Images.pix255_255_255).getHeight() - ImageManager.getImage(Images.slider_gradient).getHeight(), Menu_InGame_View_ProvinceValue.this.getWidth() / 4, 1);
                ImageManager.getImage(Images.slider_gradient).draw(oSB, Menu_InGame_View_ProvinceValue.this.getPosX() + Menu_InGame_View_ProvinceValue.this.getWidth() - Menu_InGame_View_ProvinceValue.this.getWidth() / 4 + iTranslateX, Menu_InGame_View_ProvinceValue.this.getPosY() - ImageManager.getImage(Images.pix255_255_255).getHeight() - ImageManager.getImage(Images.slider_gradient).getHeight(), Menu_InGame_View_ProvinceValue.this.getWidth() / 4, 1, true, false);
                oSB.setColor(Color.WHITE);
                ImageManager.getImage(Images.victoryPoints).draw(oSB, nPosX + CFG.PADDING * 2 + iTranslateX, Menu_InGame_View_ProvinceValue.this.getPosY() - this.getHeight() / 2 - ImageManager.getImage(Images.victoryPoints).getHeight() / 2);
