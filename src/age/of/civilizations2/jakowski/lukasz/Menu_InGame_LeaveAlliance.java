...
class Menu_InGame_LeaveAlliance
extends SliderMenu {
    protected Menu_InGame_LeaveAlliance(int onCivID) {
        ArrayList<MenuElement> menuElements = new ArrayList<MenuElement>();
        int tempWidth = CFG.CIV_INFO_MENU_WIDTH * 2;
        int tY = 0;
        menuElements.add(new Button_Diplomacy_CallToArms(Images.diplo_alliance, CFG.langManager.get("LeaveAlliance"), CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), 2, tY, CFG.BUTTON_WIDTH * 2, 2){
        ...
        this.initMenu(new SliderMenuTitle(CFG.langManager.get("LeaveAlliance"), CFG.BUTTON_HEIGHT * 3 / 5, true, true){
