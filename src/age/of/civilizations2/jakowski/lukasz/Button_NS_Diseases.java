...
class Button_NS_Diseases extends Button {
   ...
   protected Button_NS_Diseases(int iPosX, int iPosY, int iWidth) {
      ...
      ImageManager.getImage(Images.population)
         .draw(
            ...
            this.getPosY()
               ...
               - (int)((float)ImageManager.getImage(Images.population).getHeight() * this.getImageScale(Images.population, 0.65F)) / 2
               - ImageManager.getImage(Images.population).getHeight()
               + iTranslateY,
            (int)((float)ImageManager.getImage(Images.population).getWidth() * this.getImageScale(Images.population, 0.65F)),
            (int)((float)ImageManager.getImage(Images.population).getHeight() * this.getImageScale(Images.population, 0.65F))
         );
