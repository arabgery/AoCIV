...
class EventsManager {
   ...
   protected Event_SelectCivAction eSelectCivAction = Event_SelectCivAction.SELECT_RECIPENT;
   ...
   protected final void checkCondtsitionsAndTryRun(int i) {
      ...
      if (!canRunEvent) {
         ...
         for(int j = 0; j < this.eventsGD.lEvents.get(i).lTriggers.size(); ++j) {
            if (this.eventsGD.lEvents.get(i).lTriggers.get(j).triggerType != Event_Type.OR) {
               if (this.eventsGD.lEvents.get(i).lTriggers.get(j).triggerType == Event_Type.AND) {
                  if (!this.eventsGD.lEvents.get(i).lTriggers.get(j).getTriggerOut()) {
                     canRunEvent = false;
                     break;
                  }

                  checked = true;
               } else if (this.eventsGD.lEvents.get(i).lTriggers.get(j).triggerType == Event_Type.NOT) {
                  if (this.eventsGD.lEvents.get(i).lTriggers.get(j).getTriggerOut()) {
                     canRunEvent = false;
                     break;
                  }
   ...
   protected final void updateEventsAferRemoveCiv(int nRemovedCivID) {
      for(int i = 0; i < this.eventsGD.iEventsSize; ++i) {
         if (this.eventsGD.lEvents.get(i).getCivID() == nRemovedCivID) {
            ...
            for(int j = 0; j < this.eventsGD.lEvents.get(i).lDecisions.size(); ++j) {
               for(int k = 0; k < this.eventsGD.lEvents.get(i).lDecisions.get(j).lOutcomes.size(); ++k) {
                  this.eventsGD.lEvents.get(i).lDecisions.get(j).lOutcomes.get(k).updateCivIDAfterRemove(nRemovedCivID);
               }
            }
         }
      }
   ...
   protected final void swapIDsOfCivs(int nID_A, int nID_B) {
      for(int i = 0; i < this.eventsGD.iEventsSize; ++i) {
         ...
         for(int j = 0; j < this.eventsGD.lEvents.get(i).lDecisions.size(); ++j) {
            for(int k = 0; k < this.eventsGD.lEvents.get(i).lDecisions.get(j).lOutcomes.size(); ++k) {
               if (this.eventsGD.lEvents.get(i).lDecisions.get(j).lOutcomes.get(k).getCivID() == nID_A) {
                  this.eventsGD.lEvents.get(i).lDecisions.get(j).lOutcomes.get(k).setCivID(nID_B);
               } else if (this.eventsGD.lEvents.get(i).lDecisions.get(j).lOutcomes.get(k).getCivID() == nID_B) {
                  this.eventsGD.lEvents.get(i).lDecisions.get(j).lOutcomes.get(k).setCivID(nID_A);
               }

               if (this.eventsGD.lEvents.get(i).lDecisions.get(j).lOutcomes.get(k).getCivID2() == nID_A) {
                  this.eventsGD.lEvents.get(i).lDecisions.get(j).lOutcomes.get(k).setCivID2(nID_B);
               } else if (this.eventsGD.lEvents.get(i).lDecisions.get(j).lOutcomes.get(k).getCivID2() == nID_B) {
                  this.eventsGD.lEvents.get(i).lDecisions.get(j).lOutcomes.get(k).setCivID2(nID_A);
               }
            }
         }
      }
