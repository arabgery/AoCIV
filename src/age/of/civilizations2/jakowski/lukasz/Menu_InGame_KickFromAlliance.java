...
class Menu_InGame_KickFromAlliance
extends SliderMenu {
    private int iOnCivID = 0;

    protected Menu_InGame_KickFromAlliance(int onCivID) {
        ArrayList<MenuElement> menuElements = new ArrayList<MenuElement>();
        int tempWidth = CFG.CIV_INFO_MENU_WIDTH * 2;
        int tY = 0;
        this.iOnCivID = onCivID;
        menuElements.add(new Button_Diplomacy_CallToArms(Images.diplo_alliance, CFG.langManager.get("KickFromAlliance") + ": ", this.iOnCivID, 2, tY, CFG.BUTTON_WIDTH * 2, 2){
        ...
        menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Confirm"), -1, 2, tY, CFG.BUTTON_WIDTH, true){
            ...
            protected void buildElementHover() {
                ...
                nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.game.getCiv(Menu_InGame_KickFromAlliance.this.iOnCivID).getCivName(), CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE));
        ...
        this.initMenu(new SliderMenuTitle(CFG.langManager.get("KickFromAlliance"), CFG.BUTTON_HEIGHT * 3 / 5, true, true){
