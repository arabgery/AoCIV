        ...
        switch (iID) {
            ...
            case 1: {
                ...
                for (i = 0; i < CFG.peaceTreatyData.peaceTreatyGameData.lCivsDemands_Defenders.size(); ++i) {
                    if (CFG.peaceTreatyData.peaceTreatyGameData.lCivsDemands_Defenders.get((int)i).lDemands.size() <= 0) continue;
                ...
                if (!someoneMadeDemands) {
                    for (i = 0; i < CFG.peaceTreatyData.peaceTreatyGameData.lCivsDemands_Aggressors.size(); ++i) {
                        if (CFG.peaceTreatyData.peaceTreatyGameData.lCivsDemands_Aggressors.get((int)i).lDemands.size() <= 0) continue;
                        someoneMadeDemands = true;
