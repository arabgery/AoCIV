...
class Menu_CreateScenario_Events_Out_CreateAVassal
extends SliderMenu {
    ...
    protected void updateLanguage() {
        ...
        try {
            this.getMenuElement(1).setText(CFG.eventsManager.lCreateScenario_Event.lDecisions.get((int)CFG.eventsManager.iCreateEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.iCreateEvent_EditConditionID).getCivID() >= 0 ? CFG.langManager.get("Lord") + ": " + CFG.game.getCiv(CFG.eventsManager.lCreateScenario_Event.lDecisions.get((int)CFG.eventsManager.iCreateEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.iCreateEvent_EditConditionID).getCivID()).getCivName() : CFG.langManager.get("Lord"));
        }
        catch (IndexOutOfBoundsException ex) {
            this.getMenuElement(1).setText(CFG.langManager.get("Lord"));
        }
        try {
            this.getMenuElement(2).setText(CFG.eventsManager.lCreateScenario_Event.lDecisions.get((int)CFG.eventsManager.iCreateEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.iCreateEvent_EditConditionID).getCivID2() >= 0 ? CFG.langManager.get("Vassal") + ": " + CFG.game.getCiv(CFG.eventsManager.lCreateScenario_Event.lDecisions.get((int)CFG.eventsManager.iCreateEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.iCreateEvent_EditConditionID).getCivID2()).getCivName() : CFG.langManager.get("Vassal"));
        }
        catch (IndexOutOfBoundsException ex) {
