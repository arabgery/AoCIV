...
class Menu_InGame_BuildingsConstructed
extends SliderMenu {
    protected static int iSort = 1;

    protected Menu_InGame_BuildingsConstructed(int tInit) {
    ...
    protected Menu_InGame_BuildingsConstructed() {
        int i;
        ArrayList<MenuElement> menuElements = new ArrayList<MenuElement>();
        ...
        menuElements.add(new Button_Statistics_Title(CFG.langManager.get("ConstructedBuildings"), CFG.PADDING, CFG.PADDING * 2 + CFG.BUTTON_WIDTH * 5, 0, CFG.BUTTON_WIDTH, tElemHeight){
        ...
        if (iSort == 0) {
            ...
            for (int i2 = 1; i2 < CFG.game.getCivsSize(); ++i2) {
                ...
                tempScore.add(CFG.game.getCiv((int)CFG.game.getSortedCivsAZ((int)(i2 - 1))).civGameData.iNumOfBuildingsConstructed);
            }
            int tAddID = 0;
        ...
        for (i = 0; i < iSize; ++i) {
            ...
            menuElements.add(new Button_Statistics(CFG.getNumberWithSpaces("" + CFG.game.getCiv((int)((Integer)tSorted.get((int)i)).intValue()).civGameData.iNumOfBuildingsConstructed), CFG.PADDING, CFG.PADDING * 2 + CFG.BUTTON_WIDTH * 5, tPosY, CFG.BUTTON_WIDTH, tElemHeight2){
