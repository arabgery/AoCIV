...
class Event_Outcome_UpdateEconomyPerc extends Event_Outcome {
               ...
               CFG.game
                  ...
                  .setEconomy(
                     CFG.game.getProvince(this.getProvinces().get(i)).getEconomy()
                        + (int)((float)CFG.game.getProvince(this.getProvinces().get(i)).getEconomy() * ((float)this.getValue() / 100.0F))
                  );
            }
         }
      }
