...
class Button_BotBar_Invest extends Button_BotBar {
   protected Button_BotBar_Invest(String sText, float FONT_SCALE, int iPosX, int iPosY, int iMinWidth, boolean isClickable, boolean isVisible) {
