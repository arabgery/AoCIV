...
class Button_Diplomacy_Message_Pact extends Button_Statistics {
   ...
   protected Button_Diplomacy_Message_Pact(int nImageID, String sText, int nAggressor, String sRight, int iPosX, int iPosY, int iWidth) {
