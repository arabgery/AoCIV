...
extends Button_Menu {
    protected Button_Menu_LR_MainMenu_Rate(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight, boolean isClickable) {
        super(sText, iTextPositionX, iPosX, iPosY, iWidth, iHeight, isClickable);
    }

    protected Button_Menu_LR_MainMenu_Rate(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight, boolean isClickable, boolean checkboxState) {
    ...
    protected void drawButtonBG(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
        ...
        if (animationState >= 0) {
            if (animationState == 0) {
                ...
                oSB.setColor(Button_Menu_LR_MainMenu_Rate.getColorLine());
    ...
    protected Color getColor(boolean isActive) {
        return isActive ? CFG.COLOR_BUTTON_MENU_TEXT_ACTIVE : (this.getClickable() ? (this.getIsHovered() ? CFG.COLOR_BUTTON_MENU_TEXT_HOVERED : CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE) : CFG.COLOR_BUTTON_MENU_TEXT_NOT_CLICKABLE);
    }
}
