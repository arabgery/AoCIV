...
import age.of.civilizations2.jakowski.lukasz.Button_Diplomacy_Message_JoinAWar_Denied;
...
class Menu_InGame_Message_CallToArms_Denied
extends SliderMenu {
    ...
    protected Menu_InGame_Message_CallToArms_Denied() {
    ...
    protected Menu_InGame_Message_CallToArms_Denied(int onCivID, int iMessageID, int iValue) {
        ArrayList<MenuElement> menuElements = new ArrayList<MenuElement>();
        ...
        int tempWidth = CFG.CIV_INFO_MENU_WIDTH * 2;
        int tY = 0;
        menuElements.add(new Button_Diplomacy_Message_JoinAWar_Denied(CFG.langManager.get("XDeniedToJoinTheWar", CFG.game.getCiv(this.iOnCivID).getCivName()) + ":", this.iOnCivID, iValue, CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), 2, tY, CFG.BUTTON_WIDTH * 2){
        ...
        tY += ((MenuElement)menuElements.get(menuElements.size() - 1)).getHeight();
        menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("SendAnInsult"), -1, 2 + CFG.PADDING, tY += CFG.PADDING, CFG.BUTTON_WIDTH, true){
        ...
        menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Fine") + "!", -1, 2, tY, CFG.BUTTON_WIDTH, true){
        ...
        this.initMenu(new SliderMenuTitle(CFG.langManager.get("CallToArms"), CFG.BUTTON_HEIGHT * 3 / 5, true, true){
            ...
            protected void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                ...
                ImageManager.getImage(Images.diplo_message).draw(oSB, Menu_InGame_Message_CallToArms_Denied.this.getPosX() + CFG.PADDING * 2 + iTranslateX, Menu_InGame_Message_CallToArms_Denied.this.getPosY() - this.getHeight() / 2 - ImageManager.getImage(Images.diplo_message).getHeight() / 2);
                CFG.fontMain.getData().setScale(0.8f);
