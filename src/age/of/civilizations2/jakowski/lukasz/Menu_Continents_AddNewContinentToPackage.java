...
class Menu_Continents_AddNewContinentToPackage
extends SliderMenu {
    private List<String> lTags = new ArrayList<String>();
    private List<Color> lColors = new ArrayList<Color>();

    protected Menu_Continents_AddNewContinentToPackage() {
        ...
        try {
            ...
            for (int i = 0; i < tagsSPLITED.length; ++i) {
                ...
                menuElements.add(new Button_Menu(CFG.getContinentDataName(tagsSPLITED[i]), (int)(50.0f * CFG.GUI_SCALE), 0, CFG.BUTTON_HEIGHT * (tempAdded + 1) + CFG.PADDING * (tempAdded + 2), CFG.GAME_WIDTH - CFG.BUTTON_WIDTH * 2, CFG.BUTTON_HEIGHT, true));
