...
class Graph_Vertical_Data_Value_PopulationAllAroundTheWorld extends Graph_Vertical_Data_Value {
   protected Graph_Vertical_Data_Value_PopulationAllAroundTheWorld(int iValue, int iColorDataID) {
