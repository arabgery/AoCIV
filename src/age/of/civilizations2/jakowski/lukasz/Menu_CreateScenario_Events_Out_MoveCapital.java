...
class Menu_CreateScenario_Events_Out_MoveCapital
extends SliderMenu {
    protected Menu_CreateScenario_Events_Out_MoveCapital() {
    ...
    protected void updateLanguage() {
        ...
        try {
            this.getMenuElement(2).setText(CFG.langManager.get("Capital") + ": " + (CFG.eventsManager.lCreateScenario_Event.lDecisions.get((int)CFG.eventsManager.iCreateEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.iCreateEvent_EditConditionID).getValue() >= 0 ? CFG.game.getProvince(CFG.eventsManager.lCreateScenario_Event.lDecisions.get((int)CFG.eventsManager.iCreateEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.iCreateEvent_EditConditionID).getValue()).getName() : ""));
        }
        catch (IndexOutOfBoundsException ex) {
