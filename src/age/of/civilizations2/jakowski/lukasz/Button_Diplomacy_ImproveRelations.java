...
class Button_Diplomacy_ImproveRelations extends Button_Statistics {
   ...
   protected Button_Diplomacy_ImproveRelations(String sText, float iRelationDiff, int nAggressor, int nDefender, int iPosX, int iPosY, int iWidth) {
   ...
   protected void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      CFG.game
         ...
         .draw(
            oSB,
            this.getPosX() + this.iRelationWidth + this.iCurrentRelationWidth + CFG.PADDING * 2 + (int)((float)this.getTextWidth() * 0.7F) + 2 + iTranslateX,
            this.getPosY()
               + CFG.PADDING * 2
