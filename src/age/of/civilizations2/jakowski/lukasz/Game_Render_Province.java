...
class Game_Render_Province {
   protected static Game_Render_Province.DrawProvinces drawProvinces;
      ...
      if (CFG.menuManager.getInGameView()) {
                              ...
                              if (CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID()
                                 ...
                                 oSB.setColor(
                                    new Color(
                                       ...
                                       (float)CFG.settingsManager.PROVINCE_ALPHA / 255.0F * 0.5F
                                    )
                                 );
                              }
                        ...
                        if (CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID() == CFG.MANAGE_DIPLOMACY_CUSTOMIZE_ALLIANCE_ID) {
                           oSB.setColor(
                              new Color(
                                 ...
                                 (float)CFG.game.getCiv(CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID()).getG() / 255.0F,
                                 (float)CFG.game.getCiv(CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID()).getB() / 255.0F,
                                 (float)CFG.settingsManager.PROVINCE_ALPHA / 255.0F * 0.7F
                              )
                           );
                           CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).drawLandProvince(oSB);
                        } else if (CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID() > 0) {
                              ...
                              if (CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID() == CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV1) {
                                 oSB.setColor(
                                    ...
                                    .getCivNonAggressionPact(
                                       CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID(), CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV1
                                    )
                                 > 0) {
                                 oSB.setColor(
                                    CFG.getPactColor(
                        ...
                        if (CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID() != 0) {
                           if (CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID()
                              ...
                              oSB.setColor(
                                 ...
                                 .getCivNonAggressionPact(
                                    CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID(),
                                    CFG.game.getProvince(CFG.game.getActiveProvinceID()).getCivID()
                                 )
                              > 0) {
                              oSB.setColor(
                           ...
                           if (CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID() != 0) {
                              if (CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID() == CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV1) {
                                 oSB.setColor(
                                    ...
                                    .getCivTruce(CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID(), CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV1)
                                 > 0) {
                           ...
                           if (CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID() != 0) {
                              if (CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID() == CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV1) {
                                 oSB.setColor(
                                    ...
                                    .getGuarantee(CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV1, CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID())
                                 > 0) {
                                 oSB.setColor(
                                    new Color(
                           ...
                           if (CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID() != 0) {
                              if (CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID() == CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV1) {
                                 oSB.setColor(
                                    ...
                                    .getDefensivePact(CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV1, CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID())
                                 > 0) {
                                 oSB.setColor(
                                    new Color(
                           ...
                           if (CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID() != 0) {
                              if (CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID() == CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV1) {
                                 oSB.setColor(
                                    ...
                                    .getMilitaryAccess(
                                       CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV1, CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID()
                                    )
                                 > 0) {
                                 oSB.setColor(
                                    new Color(
         ...
         drawProvinces = new Game_Render_Province.DrawProvinces() {
            ...
            public void draw(SpriteBatch oSB) {
               oSB.setColor(
                  new Color(
                     (float)CFG.editorCivilization_GameData.getR() / 255.0F,
                     (float)CFG.editorCivilization_GameData.getG() / 255.0F,
                     (float)CFG.editorCivilization_GameData.getB() / 255.0F,
                     CFG.ALPHA_DIPLOMACY
                  )
               );
   ...
   protected static final void drawProvinces_FormableCiv(SpriteBatch oSB) {
            ...
            if (CFG.game.getProvince(CFG.formableCivs_GameData.getProvinceID(i)).getCivID()
               ...
               oSB.setColor(
                  new Color(
                     ...
                     (float)CFG.settingsManager.PROVINCE_ALPHA / 255.0F * 0.85F
                  )
               );
            }
      ...
      for(int i = 0; i < CFG.NUM_OF_PROVINCES_IN_VIEW; ++i) {
         if (CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getDrawProvince()
            && CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID() == CFG.game.getCiv(CFG.MANAGE_DIPLOMACY_CUSTOMIZE_RELATIONS_CIV_ID).getCivID()
            )
          {
            CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).setProvinceColor(oSB);
            oSB.setColor(
               new Color(
                  ...
                  (float)CFG.game.getCiv(CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID()).getG() / 255.0F,
                  (float)CFG.game.getCiv(CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID()).getB() / 255.0F,
                  (float)CFG.settingsManager.PROVINCE_ALPHA / 255.0F * 0.35F
               )
            );
            CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).drawLandProvince(oSB);
         }
   ...
   protected static final void drawProvinces_FormableCiv_FogOfWarDiscovery(SpriteBatch oSB) {
            ...
            if (CFG.game.getPlayer(CFG.PLAYER_TURNID).getMetProvince(CFG.formableCivs_GameData.getProvinceID(i))
               ...
               oSB.setColor(
                  new Color(
                     ...
                     CFG.COLOR_TEXT_MODIFIER_NEGATIVE2.g,
                     CFG.COLOR_TEXT_MODIFIER_NEGATIVE2.b,
                     (float)CFG.settingsManager.PROVINCE_ALPHA / 255.0F * 0.75F
                  )
               );
            }
      ...
      for(int i = 0; i < CFG.NUM_OF_PROVINCES_IN_VIEW; ++i) {
         if (CFG.game.getPlayer(CFG.PLAYER_TURNID).getMetProvince(CFG.game.getProvinceInViewID(i))
            && CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getDrawProvince()
            && CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID() == CFG.game.getCiv(CFG.MANAGE_DIPLOMACY_CUSTOMIZE_RELATIONS_CIV_ID).getCivID()
            )
          {
            oSB.setColor(
   ...
   protected static final void drawProvinces_Timeline(SpriteBatch oSB) {
      ...
      for(int i = 0; i < CFG.NUM_OF_PROVINCES_IN_VIEW; ++i) {
         if (CFG.timelapseManager.timelineOwners.get(CFG.game.getProvinceInViewID(i)) > 0) {
            CFG.game
               .getProvince(CFG.game.getProvinceInViewID(i))
               .setCivilizationProvinceColor(oSB, CFG.timelapseManager.timelineOwners.get(CFG.game.getProvinceInViewID(i)));
            CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).drawLandProvince(oSB);
         }
      }
      ...
      for(int i = 0; i < CFG.NUM_OF_PROVINCES_IN_VIEW; ++i) {
         if (CFG.timelapseManager.timelineOwners_IsOccupied.get(CFG.game.getProvinceInViewID(i))) {
            CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).drawOccupiedProvince(oSB);
         }
      }
   ...
   protected static final void drawProvinces_PeaceTreaty(SpriteBatch oSB) {
      ...
      for(int i = 0; i < CFG.NUM_OF_PROVINCES_IN_VIEW; ++i) {
         if (CFG.peaceTreatyData.drawProvinceOwners.get(CFG.game.getProvinceInViewID(i)).iCivID != 0) {
            if (CFG.peaceTreatyData.drawProvinceOwners.get(CFG.game.getProvinceInViewID(i)).iCivID < 0) {
               oSB.setColor(
                  new Color(
                     (float)CFG.game.getCiv(CFG.peaceTreatyData.drawProvinceOwners.get(CFG.game.getProvinceInViewID(i)).iCivID * -1).getR() / 255.0F,
                     (float)CFG.game.getCiv(CFG.peaceTreatyData.drawProvinceOwners.get(CFG.game.getProvinceInViewID(i)).iCivID * -1).getG() / 255.0F,
                     (float)CFG.game.getCiv(CFG.peaceTreatyData.drawProvinceOwners.get(CFG.game.getProvinceInViewID(i)).iCivID * -1).getB() / 255.0F,
                     (float)CFG.settingsManager.PROVINCE_ALPHA / 255.0F * 0.25F
                  )
               );
               CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).drawLandProvince(oSB);
      ...
      for(int i = 0; i < CFG.NUM_OF_PROVINCES_IN_VIEW; ++i) {
         if (CFG.peaceTreatyData.drawProvinceOwners.get(CFG.game.getProvinceInViewID(i)).isToTake
            && CFG.peaceTreatyData.drawProvinceOwners.get(CFG.game.getProvinceInViewID(i)).isTaken < 0) {
            CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).drawOccupiedProvince(oSB);
         }
      }
         ...
         if (CFG.getMetProvince(CFG.game.getProvinceInViewID(i))) {
            ...
            oSB.setColor(
               new Color(
                  ...
                  CFG.settingsManager.COLOR_PROVINCE_DISCOVERY.getB(),
                  CFG.settingsManager.COLOR_PROVINCE_DISCOVERY_ALPHA
                     * ((float)CFG.startTheGameData.getProvincesAlpha() / (float)CFG.settingsManager.PROVINCE_ALPHA)
               )
            );
            CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).drawLandProvince(oSB);
         }
   ...
   protected static final void drawProvincesInMapEditor_Connections(SpriteBatch oSB) {
      ...
      if (CFG.VIEW_SHOW_VALUES) {
         for(int i = 0; i < CFG.NUM_OF_PROVINCES_IN_VIEW; ++i) {
            for(int j = 0; j < CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getProvinceBordersLandByLandSize(); ++j) {
               drawProvincesInMapEditor_Connections_Line(
                  oSB,
                  Images.pix255_255_255,
                  CFG.game.getProvinceInViewID(i),
                  CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getProvinceBordersLandByLand().get(j).getWithProvinceID()
               );
            }

            for(int j = 0; j < CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getProvinceBordersLandBySeaSize(); ++j) {
               drawProvincesInMapEditor_Connections_Line(
                  oSB,
                  Images.line_33,
                  CFG.game.getProvinceInViewID(i),
                  CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getProvinceBordersLandBySea().get(j).getWithProvinceID()
               );
            }
         }

         for(int i = 0; i < CFG.NUM_OF_SEA_PROVINCES_IN_VIEW; ++i) {
            for(int j = 0; j < CFG.game.getProvince(CFG.game.getSeaProvinceInViewID(i)).getProvinceBordersLandBySeaSize(); ++j) {
               drawProvincesInMapEditor_Connections_Line(
                  oSB,
                  Images.line_33,
                  CFG.game.getSeaProvinceInViewID(i),
                  CFG.game.getProvince(CFG.game.getSeaProvinceInViewID(i)).getProvinceBordersLandBySea().get(j).getWithProvinceID()
               );
            }

            oSB.setColor(new Color(1.0F, 1.0F, 1.0F, 0.25F));

            for(int j = 0; j < CFG.game.getProvince(CFG.game.getSeaProvinceInViewID(i)).getProvinceBordersSeaBySeaSize(); ++j) {
               drawProvincesInMapEditor_Connections_Line(
                  oSB,
                  Images.line_33,
                  CFG.game.getSeaProvinceInViewID(i),
                  CFG.game.getProvince(CFG.game.getSeaProvinceInViewID(i)).getProvinceBordersSeaBySea().get(j).getWithProvinceID()
               );
            }
         }
      }
   ...
   protected static final void drawProvincesInGameEditorRegions(SpriteBatch oSB) {
      ...
      for(int i = 0; i < CFG.NUM_OF_PROVINCES_IN_VIEW; ++i) {
         oSB.setColor(Menu_GameEditor_Regions.lColors.get(CFG.game.getRegionID(CFG.game.getProvinceInViewID(i))));
         CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).drawLandProvince(oSB);
      }

      for(int i = 0; i < CFG.NUM_OF_SEA_PROVINCES_IN_VIEW; ++i) {
         oSB.setColor(Menu_GameEditor_Regions.lColors.get(CFG.game.getRegionID(CFG.game.getSeaProvinceInViewID(i))));
         CFG.game.getProvince(CFG.game.getSeaProvinceInViewID(i)).drawProvince_ActiveProvince(oSB);
      }
            ...
            if (CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getIsCapital()) {
               CFG.game
                  ...
                  .setCivilizationProvinceColor(
                     oSB, CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID(), (float)CFG.startTheGameData.getCapitalsAlpha() / 255.0F
                  );
            } else {
               CFG.game
                  .getProvince(CFG.game.getProvinceInViewID(i))
                  .setCivilizationProvinceColor(
                     oSB, CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID(), (float)CFG.startTheGameData.getProvincesAlpha() / 255.0F
                  );
            }
   ...
   protected static final void drawProvincesInStartGame_FogOfWarDiscovery(SpriteBatch oSB) {
      ...
      for(int i = 0; i < CFG.NUM_OF_WASTELAND_PROVINCES_IN_VIEW; ++i) {
         if (CFG.getMetProvince(CFG.game.getWastelandProvinceInViewID(i))) {
            CFG.game
               .getProvince(CFG.game.getWastelandProvinceInViewID(i))
               .drawWastelandProvince(oSB, (float)CFG.startTheGameData.getWastelandAlpha() / 255.0F);
         } else {
            oSB.setColor(
               new Color(
                  CFG.settingsManager.COLOR_PROVINCE_DISCOVERY.getR(),
