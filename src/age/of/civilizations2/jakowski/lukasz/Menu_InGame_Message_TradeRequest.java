...
import age.of.civilizations2.jakowski.lukasz.Button_Diplomacy_MessageAlliance_Center;
...
import age.of.civilizations2.jakowski.lukasz.Button_Statistics_Gold;
...
class Menu_InGame_Message_TradeRequest
extends SliderMenu {
    ...
    protected Menu_InGame_Message_TradeRequest() {
    ...
    protected Menu_InGame_Message_TradeRequest(int onCivID, int nMessageID, TradeRequest_GameData tradeRequest) {
        ArrayList<MenuElement> menuElements = new ArrayList<MenuElement>();
        ...
        menuElements.add(new Button_Diplomacy_MessageAlliance_Center(CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getCivName(), CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), 2, tY, CFG.BUTTON_WIDTH * 2){
        ...
        if (tradeRequest.listLEFT.iGold > 0) {
            menuElements.add(new Button_Statistics_Gold(CFG.langManager.get("Gold") + ": ", "" + tradeRequest.listLEFT.iGold, CFG.PADDING * 2, 2, tY, CFG.BUTTON_WIDTH * 2, CFG.TEXT_HEIGHT + CFG.PADDING * 2){
        ...
        if (tradeRequest.listLEFT.lProvinces.size() > 0) {
            menuElements.add(new Button_Diplomacy_MessageAlliance(CFG.langManager.get("Provinces") + ": " + tradeRequest.listLEFT.lProvinces.size(), tradeRequest.iCivLEFT, 2, tY, CFG.BUTTON_WIDTH * 2, CFG.TEXT_HEIGHT + CFG.PADDING * 2){
                ...
                protected Color getColor(boolean isActive) {
                    return isActive ? CFG.COLOR_TEXT_OPTIONS_NS_ACTIVE : (this.getClickable() ? (this.getIsHovered() ? CFG.COLOR_TEXT_OPTIONS_NS : CFG.COLOR_TEXT_OPTIONS_NS_HOVER) : CFG.COLOR_BUTTON_MENU_TEXT_NOT_CLICKABLE);
                }
                ...
                protected void buildElementHover() {
                    try {
                        ...
                        for (int i = 0; i < CFG.game.getCiv((int)CFG.game.getPlayer((int)CFG.PLAYER_TURNID).getCivID()).getCivilization_Diplomacy_GameData().messageBox.getMessage((int)((Menu_InGame_Message_TradeRequest)Menu_InGame_Message_TradeRequest.this).iMessageID).tradeRequest.listLEFT.lProvinces.size(); ++i) {
                            nData.add(new MenuElement_Hover_v2_Element_Type_Flag(CFG.game.getProvince(CFG.game.getCiv((int)CFG.game.getPlayer((int)CFG.PLAYER_TURNID).getCivID()).getCivilization_Diplomacy_GameData().messageBox.getMessage((int)((Menu_InGame_Message_TradeRequest)Menu_InGame_Message_TradeRequest.this).iMessageID).tradeRequest.listLEFT.lProvinces.get(i)).getCivID()));
                            nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.game.getProvince(CFG.game.getCiv((int)CFG.game.getPlayer((int)CFG.PLAYER_TURNID).getCivID()).getCivilization_Diplomacy_GameData().messageBox.getMessage((int)((Menu_InGame_Message_TradeRequest)Menu_InGame_Message_TradeRequest.this).iMessageID).tradeRequest.listLEFT.lProvinces.get(i)).getName(), CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE));
                ...
                protected void actionElement(int iID) {
                    ...
                    for (int i = 0; i < CFG.game.getCiv((int)CFG.game.getPlayer((int)CFG.PLAYER_TURNID).getCivID()).getCivilization_Diplomacy_GameData().messageBox.getMessage((int)((Menu_InGame_Message_TradeRequest)Menu_InGame_Message_TradeRequest.this).iMessageID).tradeRequest.listLEFT.lProvinces.size(); ++i) {
                        CFG.game.getSelectedProvinces().addProvince(CFG.game.getCiv((int)CFG.game.getPlayer((int)CFG.PLAYER_TURNID).getCivID()).getCivilization_Diplomacy_GameData().messageBox.getMessage((int)((Menu_InGame_Message_TradeRequest)Menu_InGame_Message_TradeRequest.this).iMessageID).tradeRequest.listLEFT.lProvinces.get(i));
                    }
        ...
        if (tradeRequest.listLEFT.iDeclarWarOnCivID > 0) {
            menuElements.add(new Button_Diplomacy_MessageAlliance(CFG.langManager.get("DeclareWar") + ": " + CFG.game.getCiv(tradeRequest.listLEFT.iDeclarWarOnCivID).getCivName(), tradeRequest.listLEFT.iDeclarWarOnCivID, 2, tY, CFG.BUTTON_WIDTH * 2, CFG.TEXT_HEIGHT + CFG.PADDING * 2){
        ...
        if (tradeRequest.listLEFT.iFormCoalitionAgainst > 0) {
            menuElements.add(new Button_Diplomacy_MessageAlliance(CFG.langManager.get("FormACoalitionAgainst") + ": " + CFG.game.getCiv(tradeRequest.listLEFT.iFormCoalitionAgainst).getCivName(), tradeRequest.listLEFT.iFormCoalitionAgainst, 2, tY, CFG.BUTTON_WIDTH * 2, CFG.TEXT_HEIGHT + CFG.PADDING * 2){
        ...
        if (tradeRequest.listLEFT.defensivePact) {
            menuElements.add(new Button_Diplomacy_MessageAlliance(CFG.langManager.get("DefensivePact"), tradeRequest.iCivLEFT, 2, tY, CFG.BUTTON_WIDTH * 2, CFG.TEXT_HEIGHT + CFG.PADDING * 2){
        ...
        if (tradeRequest.listLEFT.nonAggressionPact) {
            menuElements.add(new Button_Diplomacy_MessageAlliance(CFG.langManager.get("NonAggressionPact"), tradeRequest.iCivLEFT, 2, tY, CFG.BUTTON_WIDTH * 2, CFG.TEXT_HEIGHT + CFG.PADDING * 2){
        ...
        if (tradeRequest.listLEFT.proclaimIndependence) {
            menuElements.add(new Button_Diplomacy_MessageAlliance(CFG.langManager.get("ProclaimIndependence"), tradeRequest.iCivLEFT, 2, tY, CFG.BUTTON_WIDTH * 2, CFG.TEXT_HEIGHT + CFG.PADDING * 2){
        ...
        if (tradeRequest.listLEFT.militaryAccess) {
            menuElements.add(new Button_Diplomacy_MessageAlliance(CFG.langManager.get("MilitaryAccess"), tradeRequest.iCivLEFT, 2, tY, CFG.BUTTON_WIDTH * 2, CFG.TEXT_HEIGHT + CFG.PADDING * 2){
        ...
        tY = ((MenuElement)menuElements.get(0)).getHeight() + CFG.PADDING;
        if (tradeRequest.listRight.iGold > 0) {
            menuElements.add(new Button_Statistics_Gold(CFG.langManager.get("Gold") + ": ", "" + tradeRequest.listRight.iGold, CFG.PADDING * 2, 2, tY, CFG.BUTTON_WIDTH * 2, CFG.TEXT_HEIGHT + CFG.PADDING * 2){
        ...
        if (tradeRequest.listRight.lProvinces.size() > 0) {
            menuElements.add(new Button_Diplomacy_MessageAlliance(CFG.langManager.get("Provinces") + ": " + tradeRequest.listRight.lProvinces.size(), tradeRequest.iCivRIGHT, 2, tY, CFG.BUTTON_WIDTH * 2, CFG.TEXT_HEIGHT + CFG.PADDING * 2){
                ...
                protected void buildElementHover() {
                    try {
                        ArrayList<MenuElement_Hover_v2_Element2> nElements = new ArrayList<MenuElement_Hover_v2_Element2>();
                        ArrayList<MenuElement_Hover_v2_Element_Type> nData = new ArrayList<MenuElement_Hover_v2_Element_Type>();
                        for (int i = 0; i < CFG.game.getCiv((int)CFG.game.getPlayer((int)CFG.PLAYER_TURNID).getCivID()).getCivilization_Diplomacy_GameData().messageBox.getMessage((int)((Menu_InGame_Message_TradeRequest)Menu_InGame_Message_TradeRequest.this).iMessageID).tradeRequest.listRight.lProvinces.size(); ++i) {
                ...
                protected void actionElement(int iID) {
                    CFG.game.getSelectedProvinces().clearSelectedProvinces();
                    for (int i = 0; i < CFG.game.getCiv((int)CFG.game.getPlayer((int)CFG.PLAYER_TURNID).getCivID()).getCivilization_Diplomacy_GameData().messageBox.getMessage((int)((Menu_InGame_Message_TradeRequest)Menu_InGame_Message_TradeRequest.this).iMessageID).tradeRequest.listRight.lProvinces.size(); ++i) {
                        CFG.game.getSelectedProvinces().addProvince(CFG.game.getCiv((int)CFG.game.getPlayer((int)CFG.PLAYER_TURNID).getCivID()).getCivilization_Diplomacy_GameData().messageBox.getMessage((int)((Menu_InGame_Message_TradeRequest)Menu_InGame_Message_TradeRequest.this).iMessageID).tradeRequest.listRight.lProvinces.get(i));
                    }
                    CFG.game.getPlayer((int)CFG.PLAYER_TURNID).iACTIVE_VIEW_MODE = CFG.viewsManager.getActiveViewID();
                    CFG.viewsManager.disableAllViews();
                    CFG.game.setActiveProvinceID(-1);
        ...
        if (tradeRequest.listRight.iDeclarWarOnCivID > 0) {
            menuElements.add(new Button_Diplomacy_MessageAlliance(CFG.langManager.get("DeclareWar") + ": " + CFG.game.getCiv(tradeRequest.listRight.iDeclarWarOnCivID).getCivName(), tradeRequest.listRight.iDeclarWarOnCivID, 2, tY, CFG.BUTTON_WIDTH * 2, CFG.TEXT_HEIGHT + CFG.PADDING * 2){
        ...
        if (tradeRequest.listRight.iFormCoalitionAgainst > 0) {
            menuElements.add(new Button_Diplomacy_MessageAlliance(CFG.langManager.get("FormACoalitionAgainst") + ": " + CFG.game.getCiv(tradeRequest.listRight.iFormCoalitionAgainst).getCivName(), tradeRequest.listRight.iFormCoalitionAgainst, 2, tY, CFG.BUTTON_WIDTH * 2, CFG.TEXT_HEIGHT + CFG.PADDING * 2){
        ...
        if (tradeRequest.listRight.defensivePact) {
            menuElements.add(new Button_Diplomacy_MessageAlliance(CFG.langManager.get("DefensivePact"), tradeRequest.iCivRIGHT, 2, tY, CFG.BUTTON_WIDTH * 2, CFG.TEXT_HEIGHT + CFG.PADDING * 2){
        ...
        if (tradeRequest.listRight.nonAggressionPact) {
            menuElements.add(new Button_Diplomacy_MessageAlliance(CFG.langManager.get("NonAggressionPact"), tradeRequest.iCivRIGHT, 2, tY, CFG.BUTTON_WIDTH * 2, CFG.TEXT_HEIGHT + CFG.PADDING * 2){
        ...
        if (tradeRequest.listRight.proclaimIndependence) {
            menuElements.add(new Button_Diplomacy_MessageAlliance(CFG.langManager.get("ProclaimIndependence"), tradeRequest.iCivRIGHT, 2, tY, CFG.BUTTON_WIDTH * 2, CFG.TEXT_HEIGHT + CFG.PADDING * 2){
        ...
        if (tradeRequest.listRight.militaryAccess) {
            menuElements.add(new Button_Diplomacy_MessageAlliance(CFG.langManager.get("MilitaryAccess"), tradeRequest.iCivRIGHT, 2, tY, CFG.BUTTON_WIDTH * 2, CFG.TEXT_HEIGHT + CFG.PADDING * 2){
        ...
        menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Refuse"), -1, 2 + CFG.PADDING, tY += CFG.PADDING, CFG.BUTTON_WIDTH, true){
        ...
        this.initMenu(new SliderMenuTitle(CFG.langManager.get("TradeRequest"), CFG.BUTTON_HEIGHT * 3 / 5, true, true){
            ...
            protected void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                ...
                ImageManager.getImage(Images.diplo_message).draw(oSB, Menu_InGame_Message_TradeRequest.this.getPosX() + CFG.PADDING * 2 + iTranslateX, Menu_InGame_Message_TradeRequest.this.getPosY() - this.getHeight() / 2 - ImageManager.getImage(Images.diplo_message).getHeight() / 2);
