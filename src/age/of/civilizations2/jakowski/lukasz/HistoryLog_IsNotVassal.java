...
class HistoryLog_IsNotVassal extends HistoryLog {
   private String sMess;
   private int iMessWidth;
   protected int iCivAWidth;

   protected HistoryLog_IsNotVassal(int iCivA, int iCivB) {
      ...
      try {
            ...
            .draw(
               ...
               iPosX
                  + (int)(
                     (
                           (float)ICON_WIDTH
                              - (float)CFG.ideologiesManager.getIdeology(CFG.game.getCiv(this.iCivA).getIdeologyID()).getiCrownVassalImage().getWidth()
               ...
               iPosY
                  + (int)(
                     (
                           (float)iHeight
                              - (float)CFG.ideologiesManager.getIdeology(CFG.game.getCiv(this.iCivA).getIdeologyID()).getiCrownVassalImage().getHeight()
                                 * getImageScale_CrownVassal(CFG.game.getCiv(this.iCivA).getIdeologyID())
                        )
                        / 2.0F
                  )
         ...
         CFG.ideologiesManager
            ...
            .draw(
               ...
               iPosX
                  + (int)(
                     ((float)ICON_WIDTH - (float)CFG.ideologiesManager.getIdeology(0).getiCrownVassalImage().getWidth() * getImageScale_CrownVassal(0)) / 2.0F
                  ),
               iPosY
                  + (int)(
                     ((float)iHeight - (float)CFG.ideologiesManager.getIdeology(0).getiCrownVassalImage().getHeight() * getImageScale_CrownVassal(0)) / 2.0F
                  )
                  - CFG.ideologiesManager.getIdeology(0).getiCrownVassalImage().getHeight(),
               (int)((float)CFG.ideologiesManager.getIdeology(0).getiCrownVassalImage().getWidth() * getImageScale_CrownVassal(0)),
               (int)((float)CFG.ideologiesManager.getIdeology(0).getiCrownVassalImage().getHeight() * getImageScale_CrownVassal(0))
            );
      }
