...
class Menu_CreateScenario_Events_Cond_Ideology
extends SliderMenu {
    protected Menu_CreateScenario_Events_Cond_Ideology() {
    ...
    protected void updateLanguage() {
        ...
        try {
            this.getMenuElement(5).setText(CFG.langManager.get("Government") + ": " + (CFG.eventsManager.lCreateScenario_Event.getTrigger((int)CFG.eventsManager.iCreateEvent_EditTriggerID).lConditions.get(CFG.eventsManager.iCreateEvent_EditConditionID).getValue() >= 0 ? CFG.ideologiesManager.getIdeology(CFG.eventsManager.lCreateScenario_Event.getTrigger((int)CFG.eventsManager.iCreateEvent_EditTriggerID).lConditions.get(CFG.eventsManager.iCreateEvent_EditConditionID).getValue()).getName() : ""));
        }
        catch (IndexOutOfBoundsException ex) {
