...
class Button_BotBar_NewColony extends Button_BotBar {
   protected Button_BotBar_NewColony(String sText, float FONT_SCALE, int iPosX, int iPosY, int iMinWidth, boolean isClickable, boolean isVisible) {
