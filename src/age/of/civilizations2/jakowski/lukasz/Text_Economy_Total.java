...
class Text_Economy_Total extends Text {
   private String sText2;
   private Color textColor;

   protected Text_Economy_Total(String sText, String sText2, int iPosX, int iPosY, int iWidth, int iHeight) {
   ...
   protected void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
      ...
      CFG.drawTextWithShadow(
         oSB,
         this.getText(),
         this.getPosX() + this.getWidth() - CFG.PADDING - CFG.PADDING / 2 - (int)((float)this.getTextWidth() * 0.8F) + iTranslateX,
   ...
   private final float getImageScale() {
      return (float)this.iTextHeight * 0.8F / (float)ImageManager.getImage(Images.top_gold).getHeight();
   }
