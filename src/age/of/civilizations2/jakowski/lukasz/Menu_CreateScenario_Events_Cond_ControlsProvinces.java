...
class Menu_CreateScenario_Events_Cond_ControlsProvinces
extends SliderMenu {
    protected Menu_CreateScenario_Events_Cond_ControlsProvinces() {
    ...
    protected void updateLanguage() {
        ...
        this.getMenuElement(5).setText(CFG.langManager.get("SelectProvinces") + ": " + CFG.eventsManager.lCreateScenario_Event.getTrigger((int)CFG.eventsManager.iCreateEvent_EditTriggerID).lConditions.get(CFG.eventsManager.iCreateEvent_EditConditionID).getProvinces().size());
