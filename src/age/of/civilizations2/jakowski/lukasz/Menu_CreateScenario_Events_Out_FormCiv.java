...
class Menu_CreateScenario_Events_Out_FormCiv
extends SliderMenu {
    protected Menu_CreateScenario_Events_Out_FormCiv() {
    ...
    protected void updateLanguage() {
        ...
        this.getMenuElement(2).setText(CFG.langManager.get("Form") + ": " + CFG.langManager.getCiv(CFG.eventsManager.lCreateScenario_Event.lDecisions.get((int)CFG.eventsManager.iCreateEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.iCreateEvent_EditConditionID).getText()));
