...
class Button_Diplomacy_Message_Gift extends Button_Statistics {
   private static final float FONT_SCALE = 0.7F;
   private String sRight;
   private int iRightWidth = 0;
   private int iCivA;

   protected Button_Diplomacy_Message_Gift(String sText, int nAggressor, String sRight, int iPosX, int iPosY, int iWidth) {
