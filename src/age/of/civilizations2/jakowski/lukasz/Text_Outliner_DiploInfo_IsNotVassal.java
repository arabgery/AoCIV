...
class Text_Outliner_DiploInfo_IsNotVassal extends Text {
   ...
   protected Text_Outliner_DiploInfo_IsNotVassal(int iCivLeft, int iCivRight, int iTurnID, int iPosX, int iPosY, int nWidth) {
