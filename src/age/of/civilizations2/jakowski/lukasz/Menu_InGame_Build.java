...
import age.of.civilizations2.jakowski.lukasz.Button_Build_Destroy;
import age.of.civilizations2.jakowski.lukasz.Button_Build_DiplomacyCost;
import age.of.civilizations2.jakowski.lukasz.Button_Build_Level;
...
import age.of.civilizations2.jakowski.lukasz.Text_BuildTitle;
import com.badlogic.gdx.graphics.Color;
import com.badlogic.gdx.graphics.g2d.SpriteBatch;
import java.util.ArrayList;

class Menu_InGame_Build
extends SliderMenu {
    ...
    protected Menu_InGame_Build() {
        ...
        if (BuildingsManager.iBuildInProvinceID >= 0) {
            ...
            boolean bl = canDestroy = CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfFarm() > 0;
            ...
            menuElements.add(new Button_Build(BuildingsManager.getArmoury_Name(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfArmoury() + 1), Images.b_armoury, BuildingsManager.getArmoury_BuildCost(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfArmoury() + 1, BuildingsManager.iBuildInProvinceID), BuildingsManager.getArmoury_BuildMovementCost(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfArmoury() + 1), 0, tPosY += ((MenuElement)menuElements.get(menuElements.size() - 1)).getHeight(), canDestroy ? tempW - Button_Build_Destroy.getButtonWidth() : tempW, true, CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfArmoury() == BuildingsManager.getArmoury_MaxLevel(), CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).isInConstruction(BuildingsManager.iBuildInProvinceID, ConstructionType.ARMOURY), BuildingsManager.getArmoury_TechLevel(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfArmoury() + 1)){
        ...
        menuElements.add(new Button_Build(CFG.langManager.get("Festival"), Images.diplo_festival, DiplomacyManager.festivalCost(BuildingsManager.iBuildInProvinceID), 8, 0, tPosY += ((MenuElement)menuElements.get(menuElements.size() - 1)).getHeight(), tempW, true, false, CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).isFestivalOrganized_TurnsLeft(BuildingsManager.iBuildInProvinceID), 0.0f){
        ...
        ((MenuElement)menuElements.get(menuElements.size() - 1)).setHeight(CFG.BUTTON_HEIGHT * 3 / 5);
        menuElements.add(new Button_Build_DiplomacyCost(CFG.langManager.get("Assimilate"), Images.diplo_popstability, DiplomacyManager.assimilateCost(BuildingsManager.iBuildInProvinceID, 1), 6, 0, tPosY += ((MenuElement)menuElements.get(menuElements.size() - 1)).getHeight(), tempW, !CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).isOccupied(), false, CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).isAssimialateOrganized_TurnsLeft(BuildingsManager.iBuildInProvinceID), 0.0f){
        ...
        ((MenuElement)menuElements.get(menuElements.size() - 1)).setHeight(CFG.BUTTON_HEIGHT * 3 / 5);
        menuElements.add(new Button_Build(CFG.langManager.get("Invest"), Images.economy, 0, 12, 0, tPosY += ((MenuElement)menuElements.get(menuElements.size() - 1)).getHeight(), tempW, true, false, CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).isInvestOrganized_TurnsLeft(BuildingsManager.iBuildInProvinceID), 0.0f){
        ...
        ((MenuElement)menuElements.get(menuElements.size() - 1)).setHeight(CFG.BUTTON_HEIGHT * 3 / 5);
        menuElements.add(new Button_Build(CFG.langManager.get("Invest"), Images.development, 0, 8, 0, tPosY += ((MenuElement)menuElements.get(menuElements.size() - 1)).getHeight(), tempW, true, false, CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).isInvestOrganized_TurnsLeft_Development(BuildingsManager.iBuildInProvinceID), 0.0f){
            ...
            protected void buildElementHover() {
                ...
                nData.add(new MenuElement_Hover_v2_Element_Type_Text("" + String.format("%.2f", Float.valueOf(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getDevelopmentLevel())).replace(',', '.'), CFG.COLOR_TEXT_MODIFIER_NEUTRAL2));
        ...
        menuElements.add(new Button_Build(CFG.langManager.get("Conscript"), Images.diplo_army, 0, 0, 0, tPosY += ((MenuElement)menuElements.get(menuElements.size() - 1)).getHeight(), tempW, true, false, 0, 0.0f){
        ...
        ((MenuElement)menuElements.get(menuElements.size() - 1)).setHeight(CFG.BUTTON_HEIGHT * 3 / 5);
        menuElements.add(new Button_Build(CFG.langManager.get("DisbandArmy"), Images.diplo_army, 0, 0, 0, tPosY += ((MenuElement)menuElements.get(menuElements.size() - 1)).getHeight(), tempW, true, false, 0, 0.0f){
        ...
        ((MenuElement)menuElements.get(menuElements.size() - 1)).setHeight(CFG.BUTTON_HEIGHT * 3 / 5);
        menuElements.add(new Button_Build(CFG.langManager.get("Plunder"), Images.diplo_plunder, 0, 0, 0, tPosY += ((MenuElement)menuElements.get(menuElements.size() - 1)).getHeight(), tempW, true, false, CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).isPlundred(BuildingsManager.iBuildInProvinceID) ? 1 : 0, 0.0f){
        ...
        ((MenuElement)menuElements.get(menuElements.size() - 1)).setHeight(CFG.BUTTON_HEIGHT * 3 / 5);
        menuElements.add(new Text_BuildTitle(CFG.langManager.get("Province"), -1, 0, tPosY += ((MenuElement)menuElements.get(menuElements.size() - 1)).getHeight(), tempW, CFG.TEXT_HEIGHT + CFG.PADDING * 4){
