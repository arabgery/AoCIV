...
import age.of.civilizations2.jakowski.lukasz.Button_Diplomacy_OfferAlliance;
...
import age.of.civilizations2.jakowski.lukasz.Button_Likelihood;
...
class Menu_InGame_OfferAlliance
extends SliderMenu {
    protected static long lTime = 0L;
    private int iOnCivID = -1;

    protected Menu_InGame_OfferAlliance() {
    ...
    protected Menu_InGame_OfferAlliance(int onCivID) {
        ...
        menuElements.add(new Button_Likelihood(DiplomacyManager.getLikelihoodScore(DiplomacyManager.getAllianceProposal_Positive(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), this.iOnCivID) + DiplomacyManager.getAllianceProposal_Negative(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), this.iOnCivID)), 0, tY += ((MenuElement)menuElements.get(menuElements.size() - 1)).getHeight() + CFG.PADDING, CFG.BUTTON_WIDTH * 2){
            ...
            protected void buildElementHover() {
                ...
                nData.add(new MenuElement_Hover_v2_Element_Type_Text((float)this.getCurrent() / 100.0f > 0.5f ? CFG.langManager.get("High") : CFG.langManager.get("Low"), (float)this.getCurrent() / 100.0f >= 0.5f ? CFG.COLOR_TEXT_MODIFIER_NEUTRAL2 : CFG.COLOR_TEXT_MODIFIER_NEGATIVE2));
                nElements.add(new MenuElement_Hover_v2_Element2(nData));
                nData.clear();
                int tNum = DiplomacyManager.getAllianceProposal_Positive(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), Menu_InGame_OfferAlliance.this.iOnCivID) + DiplomacyManager.getAllianceProposal_Negative(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), Menu_InGame_OfferAlliance.this.iOnCivID);
                nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("Score") + ": "));
                nData.add(new MenuElement_Hover_v2_Element_Type_Text((tNum > 0 ? "+" : "") + tNum, tNum > 0 ? CFG.COLOR_TEXT_MODIFIER_POSITIVE : (tNum == 0 ? CFG.COLOR_TEXT_MODIFIER_NEUTRAL2 : CFG.COLOR_TEXT_MODIFIER_NEGATIVE2)));
                nElements.add(new MenuElement_Hover_v2_Element2(nData));
                nData.clear();
                nData.add(new MenuElement_Hover_v2_Element_Type_Space());
                nElements.add(new MenuElement_Hover_v2_Element2(nData));
                nData.clear();
                tNum = DiplomacyManager.getAllianceProposal_Negative_EmbassyClosed(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), Menu_InGame_OfferAlliance.this.iOnCivID);
                if (tNum < 0) {
                ...
                if ((tNum = DiplomacyManager.getAllianceProposal_Positive_Opinion(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), Menu_InGame_OfferAlliance.this.iOnCivID)) > 0) {
                ...
                if ((tNum = DiplomacyManager.getAllianceProposal_Positive_Goverment(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), Menu_InGame_OfferAlliance.this.iOnCivID)) > 0) {
                    nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("Government") + ": "));
                    nData.add(new MenuElement_Hover_v2_Element_Type_Text("+" + tNum, CFG.COLOR_TEXT_MODIFIER_POSITIVE));
                    nElements.add(new MenuElement_Hover_v2_Element2(nData));
                    nData.clear();
                }
                if ((tNum = DiplomacyManager.getAllianceProposal_Positive_HRE(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), Menu_InGame_OfferAlliance.this.iOnCivID)) > 0) {
                    nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("HolyRomanEmpire") + ": "));
                    nData.add(new MenuElement_Hover_v2_Element_Type_Text("+" + tNum, CFG.COLOR_TEXT_MODIFIER_POSITIVE));
                    nElements.add(new MenuElement_Hover_v2_Element2(nData));
                    nData.clear();
                }
                if ((tNum = DiplomacyManager.getAllianceProposale_CivStrength(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), Menu_InGame_OfferAlliance.this.iOnCivID)) > 0) {
                    nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("CivilizationStrength") + ": "));
                    nData.add(new MenuElement_Hover_v2_Element_Type_Text("+" + tNum, CFG.COLOR_TEXT_MODIFIER_POSITIVE));
                    nElements.add(new MenuElement_Hover_v2_Element2(nData));
                    nData.clear();
                }
                if ((tNum = DiplomacyManager.getAllianceProposal_Negative_Opinion(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), Menu_InGame_OfferAlliance.this.iOnCivID)) < 0) {
                    nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("Relations") + ": "));
                    nData.add(new MenuElement_Hover_v2_Element_Type_Text("" + tNum, CFG.COLOR_TEXT_MODIFIER_NEGATIVE2));
                    nElements.add(new MenuElement_Hover_v2_Element2(nData));
                    nData.clear();
                ...
                if ((tNum = DiplomacyManager.getAllianceProposal_Negative_PowerfulAllies(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), Menu_InGame_OfferAlliance.this.iOnCivID) + DiplomacyManager.getAllianceProposal_Negative_PowerfulAllies(Menu_InGame_OfferAlliance.this.iOnCivID, CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID())) < 0) {
                    nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("Allies") + ": "));
                    nData.add(new MenuElement_Hover_v2_Element_Type_Text("" + tNum, CFG.COLOR_TEXT_MODIFIER_NEGATIVE2));
                    nElements.add(new MenuElement_Hover_v2_Element2(nData));
                    nData.clear();
                }
                if ((tNum = DiplomacyManager.getAllianceProposal_Negative_Goverment(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), Menu_InGame_OfferAlliance.this.iOnCivID)) < 0) {
                    nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("Government") + ": "));
                    nData.add(new MenuElement_Hover_v2_Element_Type_Text("" + tNum, CFG.COLOR_TEXT_MODIFIER_NEGATIVE2));
                    nElements.add(new MenuElement_Hover_v2_Element2(nData));
                    nData.clear();
                }
                if ((tNum = DiplomacyManager.getAllianceProposal_Negative_HRE(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), Menu_InGame_OfferAlliance.this.iOnCivID)) < 0) {
                    nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("HolyRomanEmpire") + ": "));
                    nData.add(new MenuElement_Hover_v2_Element_Type_Text("" + tNum, CFG.COLOR_TEXT_MODIFIER_NEGATIVE2));
                    nElements.add(new MenuElement_Hover_v2_Element2(nData));
                    nData.clear();
                ...
                if ((tNum = DiplomacyManager.getAllianceProposal_Negative_HaveACore(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), Menu_InGame_OfferAlliance.this.iOnCivID)) < 0) {
                    nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("WantsYourProvinces") + ": "));
                    nData.add(new MenuElement_Hover_v2_Element_Type_Text("" + tNum, CFG.COLOR_TEXT_MODIFIER_NEGATIVE2));
                    nElements.add(new MenuElement_Hover_v2_Element2(nData));
                    nData.clear();
                }
                if ((tNum = DiplomacyManager.getAllianceProposal_Negative_IsAVassal(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), Menu_InGame_OfferAlliance.this.iOnCivID)) < 0) {
                    nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("VassalOfAnotherCivilization") + ": "));
                    nData.add(new MenuElement_Hover_v2_Element_Type_Text("" + tNum, CFG.COLOR_TEXT_MODIFIER_NEGATIVE2));
                    nElements.add(new MenuElement_Hover_v2_Element2(nData));
                    nData.clear();
                }
                if ((tNum = DiplomacyManager.getAllianceProposal_Negative_Distance(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), Menu_InGame_OfferAlliance.this.iOnCivID)) != 0) {
        ...
        menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("SendProposal"), -1, 2, tY, CFG.BUTTON_WIDTH, true){
            ...
            protected void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
                ImageManager.getImage(Images.diplo_alliance).draw(oSB, this.getPosX() + this.getWidth() / 2 - (int)(((float)this.getTextWidth() * 0.8f + (float)ImageManager.getImage(Images.diplo_alliance).getWidth() + (float)CFG.PADDING) / 2.0f) + iTranslateX, this.getPosY() + this.getHeight() / 2 - ImageManager.getImage(Images.diplo_alliance).getHeight() / 2 + iTranslateY);
                CFG.fontMain.getData().setScale(0.8f);
                CFG.drawText(oSB, this.getText(), this.getPosX() + (this.getTextPos() < 0 ? this.getWidth() / 2 - (int)(((float)this.getTextWidth() * 0.8f + (float)ImageManager.getImage(Images.diplo_alliance).getWidth() + (float)CFG.PADDING) / 2.0f) + ImageManager.getImage(Images.diplo_alliance).getWidth() + CFG.PADDING : this.getTextPos()) + iTranslateX, this.getPosY() + this.getHeight() / 2 - (int)((float)this.getTextHeight() * 0.8f / 2.0f) + iTranslateY, this.getColor(isActive));
        ...
        int tempMenuPosY = ImageManager.getImage(Images.top_left2).getHeight() + CFG.PADDING * 2 + CFG.BUTTON_HEIGHT * 3 / 5;
        this.initMenu(new SliderMenuTitle(CFG.langManager.get("OfferAlliance"), CFG.BUTTON_HEIGHT * 3 / 5, true, true){
