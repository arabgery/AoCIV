...
class Button_Diplomacy_CallToArms extends Button_Statistics {
   ...
   protected Button_Diplomacy_CallToArms(int iImageID, String sText, int warAgainstCivID, int iPosX, int iPosY, int iWidth, int nCOST) {
   ...
   protected void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      ImageManager.getImage(Images.pix255_255_255)
         .draw(
            oSB,
            this.getPosX() + Button_Diplomacy.iDiploWidth + CFG.PADDING * 2 + (int)((float)this.getTextWidth() * 0.7F) + iTranslateX,
            this.getPosY()
               + this.getHeight() / 2
      ...
      CFG.game
         ...
         .draw(
            oSB,
            this.getPosX() + Button_Diplomacy.iDiploWidth + CFG.PADDING * 2 + (int)((float)this.getTextWidth() * 0.7F) + 2 + iTranslateX,
            this.getPosY()
               + this.getHeight() / 2
               - (int)((float)ImageManager.getImage(Images.flag_rect).getHeight() * this.getImageScale(Images.flag_rect)) / 2
