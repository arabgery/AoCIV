...
class Button_Build_Building extends Button_Build {
   ...
   protected Button_Build_Building(String sText, String sProvinceID, int nImageID, int nCost, int nMovementCost, int iPosX, int iPosY, int iWidth) {
