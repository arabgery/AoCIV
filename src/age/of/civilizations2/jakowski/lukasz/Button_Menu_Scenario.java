...
class Button_Menu_Scenario
extends Button_Menu {
    private int iScenarioID;
    private String sScenarioName;
    private String sScenarioDate;

    protected Button_Menu_Scenario(int iScenarioID, String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight, boolean isClickable) {
        super(sText, iTextPositionX, iPosX, iPosY, iWidth, iHeight, isClickable);
        this.init(iScenarioID);
    }

    protected Button_Menu_Scenario(int iScenarioID, String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight, boolean isClickable, boolean checkboxState) {
    ...
    private final void init(int iScenarioID) {
        ...
        this.sScenarioName = "" + CFG.game.getGameScenarios().getScenarioDay(iScenarioID) + " " + Game_Calendar.getMonthName(CFG.game.getGameScenarios().getScenarioMonth(iScenarioID)) + " " + CFG.gameAges.getYear(CFG.game.getGameScenarios().getScenarioYear(iScenarioID));
        this.sScenarioDate = CFG.game.getGameScenarios().getNumOfCivs(iScenarioID) + " " + CFG.langManager.get("Civilizations") + " - " + CFG.gameAges.getAge(CFG.game.getGameScenarios().getScenarioAge(iScenarioID)).getName();
    }
