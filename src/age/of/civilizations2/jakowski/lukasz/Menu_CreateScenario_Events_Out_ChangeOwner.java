...
class Menu_CreateScenario_Events_Out_ChangeOwner
extends SliderMenu {
    protected Menu_CreateScenario_Events_Out_ChangeOwner() {
    ...
    protected void updateLanguage() {
        ...
        try {
            this.getMenuElement(1).setText(CFG.eventsManager.lCreateScenario_Event.lDecisions.get((int)CFG.eventsManager.iCreateEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.iCreateEvent_EditConditionID).getCivID2() >= 0 ? CFG.langManager.get("ControlledBy") + ": " + CFG.game.getCiv(CFG.eventsManager.lCreateScenario_Event.lDecisions.get((int)CFG.eventsManager.iCreateEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.iCreateEvent_EditConditionID).getCivID2()).getCivName() : CFG.langManager.get("ControlledBy"));
        }
        catch (IndexOutOfBoundsException ex) {
            this.getMenuElement(1).setText(CFG.langManager.get("ControlledBy"));
        }
        try {
            this.getMenuElement(2).setText(CFG.eventsManager.lCreateScenario_Event.lDecisions.get((int)CFG.eventsManager.iCreateEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.iCreateEvent_EditConditionID).getCivID() >= 0 ? CFG.langManager.get("NewOwner") + ": " + CFG.game.getCiv(CFG.eventsManager.lCreateScenario_Event.lDecisions.get((int)CFG.eventsManager.iCreateEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.iCreateEvent_EditConditionID).getCivID()).getCivName() : CFG.langManager.get("NewOwner"));
        }
        catch (IndexOutOfBoundsException ex) {
            this.getMenuElement(2).setText(CFG.langManager.get("NewOwner"));
        }
        this.getMenuElement(3).setText(CFG.langManager.get("SelectProvinces") + ": " + CFG.eventsManager.lCreateScenario_Event.lDecisions.get((int)CFG.eventsManager.iCreateEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.iCreateEvent_EditConditionID).getProvinces().size());
