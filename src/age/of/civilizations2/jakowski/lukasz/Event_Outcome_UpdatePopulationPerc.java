...
class Event_Outcome_UpdatePopulationPerc extends Event_Outcome {
               ...
               CFG.game
                  ...
                  .setPopulationOfCivID(
                     ...
                     CFG.game.getProvince(this.getProvinces().get(i)).getPopulationData().getPopulationID(j)
                        + (int)(
                           (float)CFG.game.getProvince(this.getProvinces().get(i)).getPopulationData().getPopulationID(j) * ((float)this.getValue() / 100.0F)
                        )
                  );
            }
         }
