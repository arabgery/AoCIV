...
class Menu_InGame_ActionInfo_RecruitInstantly
extends SliderMenu {
    protected Menu_InGame_ActionInfo_RecruitInstantly() {
        ...
        menuElements.add(new Text_ActionInfo_Cost_Right("", 0, CFG.GAME_HEIGHT - CFG.map.getMapBG().getMinimapHeight() - CFG.PADDING - (CFG.TEXT_HEIGHT + CFG.PADDING * 2) - CFG.BUTTON_HEIGHT - CFG.PADDING * 2){
            ...
            protected void buildElementHover() {
                ArrayList<MenuElement_Hover_v2_Element2> nElements = new ArrayList<MenuElement_Hover_v2_Element2>();
                ArrayList<MenuElement_Hover_v2_Element_Type> nData = new ArrayList<MenuElement_Hover_v2_Element_Type>();
                nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("OneUnitCostsXGold", CFG.getCostOfRecruitArmyMoney_Instantly(CFG.game.getActiveProvinceID())), CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE));
        ...
        menuElements.add(new Text_ActionInfo_Turns(CFG.langManager.get("RecruitArmyInstantly"), 0 + AoCGame.LEFT, CFG.GAME_HEIGHT - CFG.map.getMapBG().getMinimapHeight() - CFG.PADDING - (CFG.TEXT_HEIGHT + CFG.PADDING * 2) * 2 - CFG.PADDING - CFG.BUTTON_HEIGHT - CFG.PADDING * 2){
