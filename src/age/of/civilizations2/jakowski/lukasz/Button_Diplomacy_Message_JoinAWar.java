...
class Button_Diplomacy_Message_JoinAWar extends Button_Statistics {
   private static final float FONT_SCALE = 0.7F;
   private int iCivA;
   private int warAgainstCivID;

   protected Button_Diplomacy_Message_JoinAWar(String sText, int nFromCivID, int warAgainstCivID, int iPosX, int iPosY, int iWidth) {
   ...
   protected void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      try {
         oSB.setColor(
            new Color(
               (float)CFG.game.getCiv(this.warAgainstCivID).getR() / 255.0F,
               (float)CFG.game.getCiv(this.warAgainstCivID).getG() / 255.0F,
               (float)CFG.game.getCiv(this.warAgainstCivID).getB() / 255.0F,
               1.0F
            )
         );
