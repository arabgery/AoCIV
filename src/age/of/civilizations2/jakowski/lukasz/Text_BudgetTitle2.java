...
class Text_BudgetTitle2 extends Text_EconomyTitle {
   protected Text_BudgetTitle2(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight) {
