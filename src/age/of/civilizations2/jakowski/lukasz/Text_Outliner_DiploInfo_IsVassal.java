...
class Text_Outliner_DiploInfo_IsVassal extends Text {
   ...
   protected Text_Outliner_DiploInfo_IsVassal(int iCivLeft, int iCivRight, int iTurnID, int iPosX, int iPosY, int nWidth) {
