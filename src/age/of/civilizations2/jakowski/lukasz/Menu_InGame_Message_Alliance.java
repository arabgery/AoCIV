...
class Menu_InGame_Message_Alliance
extends SliderMenu {
    ...
    protected Menu_InGame_Message_Alliance() {
    ...
    protected Menu_InGame_Message_Alliance(int onCivID, int iMessageID, int iValue) {
        ...
        this.initMenu(new SliderMenuTitle(CFG.langManager.get("Alliance"), CFG.BUTTON_HEIGHT * 3 / 5, true, true){
            ...
            protected void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                ...
                ImageManager.getImage(Images.diplo_message).draw(oSB, Menu_InGame_Message_Alliance.this.getPosX() + CFG.PADDING * 2 + iTranslateX, Menu_InGame_Message_Alliance.this.getPosY() - this.getHeight() / 2 - ImageManager.getImage(Images.diplo_message).getHeight() / 2);
    ...
    protected final void actionElement(int iID) {
        if (iID == this.getMenuElementsSize() - 1) {
            CFG.menuManager.rebuildMenu_InGame_AllianceInfo(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), CFG.game.getCiv((int)CFG.game.getPlayer((int)CFG.PLAYER_TURNID).getCivID()).getCivilization_Diplomacy_GameData().messageBox.getMessage((int)this.iMessageID).iFromCivID);
