...
class Menu_CreateScenario_Settings
extends SliderMenu {
    ...
    protected Menu_CreateScenario_Settings() {
        ...
        menuElements.add(new Slider(null, CFG.BUTTON_WIDTH, CFG.BUTTON_HEIGHT * 5 + CFG.PADDING * 7, Menu_InGame_FlagAction.getWindowWidth() - CFG.BUTTON_WIDTH * 2, CFG.BUTTON_HEIGHT - CFG.PADDING * 2, 0, 1000, CFG.game.getGameScenarios().getScenario_StartingArmyInCapitals() / 25){
        ...
        menuElements.add(new Slider(null, CFG.BUTTON_WIDTH, CFG.BUTTON_HEIGHT * 6 + CFG.PADDING * 8, Menu_InGame_FlagAction.getWindowWidth() - CFG.BUTTON_WIDTH * 2, CFG.BUTTON_HEIGHT - CFG.PADDING * 2, 1, 2000, CFG.game.getGameScenarios().getScenario_StartingPopulation() / 100){
        ...
        menuElements.add(new Slider(null, CFG.BUTTON_WIDTH, CFG.BUTTON_HEIGHT * 7 + CFG.PADDING * 9, Menu_InGame_FlagAction.getWindowWidth() - CFG.BUTTON_WIDTH * 2, CFG.BUTTON_HEIGHT - CFG.PADDING * 2, 1, 1000, CFG.game.getGameScenarios().getScenario_StartingEconomy() / 100){
        ...
        menuElements.add(new Button_Menu_Descripted(CFG.langManager.get("ChangeDiplomaticRelationsBetweenCivilizations"), null, (int)(50.0f * CFG.GUI_SCALE), 0, CFG.BUTTON_HEIGHT * 4 + CFG.PADDING * 5, Menu_InGame_FlagAction.getWindowWidth(), CFG.BUTTON_HEIGHT, true){
        ...
        menuElements.add(new Button_Menu(null, (int)(50.0f * CFG.GUI_SCALE), 0, CFG.BUTTON_HEIGHT * 3 + CFG.PADDING * 4, Menu_InGame_FlagAction.getWindowWidth(), CFG.BUTTON_HEIGHT, true){
        ...
        menuElements.add(new Button_Menu(null, (int)(50.0f * CFG.GUI_SCALE), 0, CFG.BUTTON_HEIGHT * 9 + CFG.PADDING * 10, Menu_InGame_FlagAction.getWindowWidth(), CFG.BUTTON_HEIGHT, true));
        ...
        menuElements.add(new Button_Menu(null, -1, 0, CFG.BUTTON_HEIGHT * 17 + CFG.PADDING * 18, Menu_InGame_FlagAction.getWindowWidth(), CFG.BUTTON_HEIGHT, true){
        ...
        menuElements.add(new Slider(null, CFG.BUTTON_WIDTH, CFG.BUTTON_HEIGHT * 8 + CFG.PADDING * 10, Menu_InGame_FlagAction.getWindowWidth() - CFG.BUTTON_WIDTH * 2, CFG.BUTTON_HEIGHT - CFG.PADDING * 2, -200, 1500, CFG.game.getGameScenarios().getScenario_StartingMoney() / 50){
        ...
        menuElements.add(new Button_Menu(null, (int)(50.0f * CFG.GUI_SCALE), 0, CFG.BUTTON_HEIGHT * 14 + CFG.PADDING * 15, Menu_InGame_FlagAction.getWindowWidth(), CFG.BUTTON_HEIGHT, true){
        ...
        menuElements.add(new Button_Menu(null, (int)(50.0f * CFG.GUI_SCALE), 0, CFG.BUTTON_HEIGHT * 12 + CFG.PADDING * 13, Menu_InGame_FlagAction.getWindowWidth(), CFG.BUTTON_HEIGHT, true));
        menuElements.add(new Button_Menu(null, (int)(50.0f * CFG.GUI_SCALE), 0, CFG.BUTTON_HEIGHT * 15 + CFG.PADDING * 16, Menu_InGame_FlagAction.getWindowWidth(), CFG.BUTTON_HEIGHT, true){
        ...
        menuElements.add(new Button_Menu(null, (int)(50.0f * CFG.GUI_SCALE), 0, CFG.BUTTON_HEIGHT * 13 + CFG.PADDING * 14, Menu_InGame_FlagAction.getWindowWidth(), CFG.BUTTON_HEIGHT, true){
        ...
        menuElements.add(new Button_Menu(null, (int)(50.0f * CFG.GUI_SCALE), 0, CFG.BUTTON_HEIGHT * 10 + CFG.PADDING * 11, Menu_InGame_FlagAction.getWindowWidth(), CFG.BUTTON_HEIGHT, true){
        ...
        menuElements.add(new Button_Menu(null, (int)(50.0f * CFG.GUI_SCALE), 0, CFG.BUTTON_HEIGHT * 11 + CFG.PADDING * 12, Menu_InGame_FlagAction.getWindowWidth(), CFG.BUTTON_HEIGHT, true){
        ...
        menuElements.add(new Button_Menu(null, (int)(50.0f * CFG.GUI_SCALE), 0, CFG.BUTTON_HEIGHT * 16 + CFG.PADDING * 17, Menu_InGame_FlagAction.getWindowWidth(), CFG.BUTTON_HEIGHT, true){
        ...
        menuElements.add(new Slider(null, CFG.BUTTON_WIDTH, CFG.BUTTON_HEIGHT * 18 + CFG.PADDING * 20, Menu_InGame_FlagAction.getWindowWidth() - CFG.BUTTON_WIDTH * 2, CFG.BUTTON_HEIGHT - CFG.PADDING * 2, 10, 200, 100 + (int)(CFG.game.getGameScenarios().getScenario_PopulationGrowthRate_Modifier() * 100.0f)){
        ...
        menuElements.add(new Slider(null, CFG.BUTTON_WIDTH, CFG.BUTTON_HEIGHT * 19 + CFG.PADDING * 21, Menu_InGame_FlagAction.getWindowWidth() - CFG.BUTTON_WIDTH * 2, CFG.BUTTON_HEIGHT - CFG.PADDING * 2, 10, 200, 100 + (int)(CFG.game.getGameScenarios().getScenario_EconomyGrowthRate_Modifier() * 100.0f)){
        ...
        menuElements.add(new Slider(null, CFG.BUTTON_WIDTH, CFG.BUTTON_HEIGHT * 20 + CFG.PADDING * 22, Menu_InGame_FlagAction.getWindowWidth() - CFG.BUTTON_WIDTH * 2, CFG.BUTTON_HEIGHT - CFG.PADDING * 2, 15, 200, 100 + (int)(CFG.game.getGameScenarios().getScenario_DiseasesDeathRate_Modifier() * 100.0f)){
        ...
        this.initMenu(null, 0 + AoCGame.LEFT, CFG.BUTTON_HEIGHT + CFG.PADDING * 2, Menu_InGame_FlagAction.getWindowWidth(), CFG.GAME_HEIGHT - (CFG.BUTTON_HEIGHT + CFG.PADDING * 2), menuElements);
        this.updateLanguage();
    }
    ...
    private final void updateStartingArmyInCapitals(int nArmyBefore) {
        for (int i = 1; i < CFG.game.getCivsSize(); ++i) {
            if (CFG.game.getCiv(i).getCapitalProvinceID() < 0 || CFG.game.getProvince(CFG.game.getCiv(i).getCapitalProvinceID()).getCivID() != i || CFG.game.getProvince(CFG.game.getCiv(i).getCapitalProvinceID()).getArmy(0) != nArmyBefore) continue;
