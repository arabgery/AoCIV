...
class Menu_InGame_TurnSummary
extends SliderMenu {
    protected Menu_InGame_TurnSummary() {
        ...
        this.initMenu(new SliderMenuTitle(CFG.langManager.get("Economy"), CFG.BUTTON_HEIGHT * 3 / 5, true, false){
            ...
            protected void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                ...
                ImageManager.getImage(Images.slider_gradient).draw(oSB, nPosX + 2 + iTranslateX, nPosY - 1 - ImageManager.getImage(Images.slider_gradient).getHeight(), (nWidth - 4) / 3, 1);
                ImageManager.getImage(Images.slider_gradient).draw(oSB, nPosX + 2 + (nWidth - 4) - (nWidth - 4) / 3 + iTranslateX, nPosY - 1 - ImageManager.getImage(Images.slider_gradient).getHeight(), (nWidth - 4) / 3, 1, true, false);
