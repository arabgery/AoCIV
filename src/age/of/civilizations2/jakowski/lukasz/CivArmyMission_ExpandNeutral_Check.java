...
public class CivArmyMission_ExpandNeutral_Check extends CivArmyMission {
   ...
   protected CivArmyMission_ExpandNeutral_Check(int nCivID, int fromProvinceID, int toProvinceID, int iArmy) {
      this.iArmy = iArmy;
   ...
   protected boolean action(int nCivID) {
      if (this.iProvinceID != this.toProvinceID) {
         RegroupArmy_Data_ExpandCheck tryRegroupArmy = new RegroupArmy_Data_ExpandCheck(nCivID, this.iProvinceID, this.toProvinceID);
