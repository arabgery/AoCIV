...
class Slider_FlagAction_Gold extends Slider {
   protected static final Color bgColor = new Color(0.0F, 0.0F, 0.0F, 0.3F);
   protected float FONT_SCALE = 0.8F;

   protected Slider_FlagAction_Gold(String sText, int iPosX, int iPosY, int iWidth, int iHeight, int iMin, int iMax, int iCurrent) {
      this.initSlider(sText, iPosX, iPosY, iWidth, iHeight, iMin, iMax, iCurrent);
   }

   protected Slider_FlagAction_Gold(String sText, int iPosX, int iPosY, int iWidth, int iHeight, int iMin, int iMax, int iCurrent, float FONT_SCALE) {
      this.initSlider(sText, iPosX, iPosY, iWidth, iHeight, iMin, iMax, iCurrent);
   ...
   protected void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
      ...
      ImageManager.getImage(Images.top_gold)
         .draw(
            ...
            this.getPosX()
               + this.getWidth()
               - CFG.PADDING * 2
               - (int)((float)this.getTextWidth() * this.FONT_SCALE)
               - (int)((float)ImageManager.getImage(Images.top_gold).getWidth() * this.getImageScale(this.FONT_SCALE, Images.top_gold))
               + iTranslateX,
            this.getPosY()
               + this.getHeight()
               - CFG.PADDING * 2
               - this.getSliderHeight()
               - (int)((float)ImageManager.getImage(Images.top_gold).getHeight() * this.getImageScale(this.FONT_SCALE, Images.top_gold))
      ...
      CFG.drawTextWithShadow(
         oSB,
         this.getDrawText(),
         this.getPosX() + this.getWidth() - CFG.PADDING - (int)((float)this.getTextWidth() * this.FONT_SCALE) + iTranslateX,
         this.getPosY() + this.getHeight() - CFG.PADDING * 2 - this.getSliderHeight() - (int)((float)CFG.TEXT_HEIGHT * this.FONT_SCALE) + iTranslateY,
