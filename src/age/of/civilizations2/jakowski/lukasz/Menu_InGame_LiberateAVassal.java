...
class Menu_InGame_LiberateAVassal
extends SliderMenu {
    private int iOnCivID = -1;

    protected Menu_InGame_LiberateAVassal() {
    ...
    protected Menu_InGame_LiberateAVassal(int onCivID) {
        ...
        int tempMenuPosY = ImageManager.getImage(Images.top_left2).getHeight() + CFG.PADDING * 2 + CFG.BUTTON_HEIGHT * 3 / 5;
        this.initMenu(new SliderMenuTitle(CFG.langManager.get("LiberateAVassal"), CFG.BUTTON_HEIGHT * 3 / 5, true, true){
