...
import age.of.civilizations2.jakowski.lukasz.Button_Diplomacy_TakeLoan_Interest;
...
class Menu_InGame_TakeLoan
extends SliderMenu {
    private int iOnCivID = -1;

    protected Menu_InGame_TakeLoan() {
    ...
    protected Menu_InGame_TakeLoan(int onCivID) {
        ...
        menuElements.add(new Button_Diplomacy_TakeLoan_Interest(CFG.langManager.get("Interest") + ": ", "0.6", 2, tY, CFG.BUTTON_WIDTH * 2){
            ...
            protected void buildElementHover() {
                ...
                nData.add(new MenuElement_Hover_v2_Element_Type_Text("" + DiplomacyManager.takeLoan_InterestRate(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), Menu_InGame_TakeLoan.this.getMenuElement(1).getCurrent(), Menu_InGame_TakeLoan.this.getMenuElement(2).getCurrent()) + "% ", CFG.COLOR_TEXT_MODIFIER_NEUTRAL2));
                ...
                nData.add(new MenuElement_Hover_v2_Element_Type_Text("+ " + (int)((float)Menu_InGame_TakeLoan.this.getMenuElement(1).getCurrent() * DiplomacyManager.takeLoan_InterestRate(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), Menu_InGame_TakeLoan.this.getMenuElement(1).getCurrent(), Menu_InGame_TakeLoan.this.getMenuElement(2).getCurrent()) / 100.0f), CFG.COLOR_TEXT_MODIFIER_NEGATIVE2));
        ...
        tY += ((MenuElement)menuElements.get(menuElements.size() - 1)).getHeight();
        menuElements.add(new Slider_FlagAction_Gold(CFG.langManager.get("Gold"), CFG.PADDING * 2, ((MenuElement)menuElements.get(menuElements.size() - 1)).getPosY() + ((MenuElement)menuElements.get(menuElements.size() - 1)).getHeight() + CFG.PADDING, tempWidth - CFG.PADDING * 3 - CFG.BUTTON_WIDTH, CFG.TEXT_HEIGHT + CFG.PADDING * 2 + CFG.PADDING * 4, 30, DiplomacyManager.takeLoan_MaxValue(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()), 30, 0.65f){
            ...
            protected void actionElement(int iID) {
                Menu_InGame_TakeLoan.this.getMenuElement(0).setCurrent((int)(DiplomacyManager.takeLoan_InterestRate(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), Menu_InGame_TakeLoan.this.getMenuElement(1).getCurrent(), Menu_InGame_TakeLoan.this.getMenuElement(2).getCurrent()) * 100.0f));
                Menu_InGame_TakeLoan.this.getMenuElement(0).setMin((int)((float)Menu_InGame_TakeLoan.this.getMenuElement(1).getCurrent() * DiplomacyManager.takeLoan_InterestRate(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), Menu_InGame_TakeLoan.this.getMenuElement(1).getCurrent(), Menu_InGame_TakeLoan.this.getMenuElement(2).getCurrent()) / 100.0f));
            }
        });
        tY += ((MenuElement)menuElements.get(menuElements.size() - 1)).getHeight() + CFG.PADDING;
        menuElements.add(new Slider_FlagAction_Date(CFG.langManager.get("Duration"), CFG.PADDING * 2, ((MenuElement)menuElements.get(menuElements.size() - 1)).getPosY() + ((MenuElement)menuElements.get(menuElements.size() - 1)).getHeight() + CFG.PADDING, tempWidth - CFG.PADDING * 3 - CFG.BUTTON_WIDTH, CFG.TEXT_HEIGHT + CFG.PADDING * 2 + CFG.PADDING * 4, 5, 30, 17, 0.65f){
        ...
        menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Confirm"), -1, 2, tY, CFG.BUTTON_WIDTH, true){
            ...
            protected void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
                ImageManager.getImage(Images.diplo_loan).draw(oSB, this.getPosX() + this.getWidth() / 2 - (int)(((float)this.getTextWidth() * 0.8f + (float)ImageManager.getImage(Images.diplo_loan).getWidth() + (float)CFG.PADDING) / 2.0f) + iTranslateX, this.getPosY() + this.getHeight() / 2 - ImageManager.getImage(Images.diplo_loan).getHeight() / 2 + iTranslateY);
                CFG.fontMain.getData().setScale(0.8f);
                CFG.drawText(oSB, this.getText(), this.getPosX() + (this.getTextPos() < 0 ? this.getWidth() / 2 - (int)(((float)this.getTextWidth() * 0.8f + (float)ImageManager.getImage(Images.diplo_loan).getWidth() + (float)CFG.PADDING) / 2.0f) + ImageManager.getImage(Images.diplo_loan).getWidth() + CFG.PADDING : this.getTextPos()) + iTranslateX, this.getPosY() + this.getHeight() / 2 - (int)((float)this.getTextHeight() * 0.8f / 2.0f) + iTranslateY, this.getColor(isActive));
                CFG.fontMain.getData().setScale(1.0f);
            }

            @Override
            protected boolean getClickable() {
                return CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getMovePoints() >= 6 && CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getLoansSize() < 5;
            }
        ...
        int tempMenuPosY = ImageManager.getImage(Images.top_left2).getHeight() + CFG.PADDING * 2 + CFG.BUTTON_HEIGHT * 3 / 5;
        this.initMenu(new SliderMenuTitle(CFG.langManager.get("TakeLoan"), CFG.BUTTON_HEIGHT * 3 / 5, true, true){
            ...
            protected void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                ...
                ImageManager.getImage(Images.top_gold).draw(oSB, nPosX + (int)((float)nWidth - ((float)this.getTextWidth() * 0.8f + (float)ImageManager.getImage(Images.top_gold).getWidth() + (float)CFG.PADDING)) / 2 + iTranslateX, Menu_InGame_TakeLoan.this.getPosY() - this.getHeight() / 2 - ImageManager.getImage(Images.top_gold).getHeight() / 2);
                CFG.fontMain.getData().setScale(0.8f);
                CFG.drawText(oSB, this.getText(), nPosX + (int)((float)nWidth - ((float)this.getTextWidth() * 0.8f + (float)ImageManager.getImage(Images.top_gold).getWidth() + (float)CFG.PADDING)) / 2 + ImageManager.getImage(Images.top_gold).getWidth() + CFG.PADDING + iTranslateX, 2 + nPosY - this.getHeight() + (int)((float)this.getHeight() - (float)this.getTextHeight() * 0.8f) / 2, Color.WHITE);
                CFG.fontMain.getData().setScale(1.0f);
            }
        ...
        this.getMenuElement(0).setCurrent((int)(DiplomacyManager.takeLoan_InterestRate(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), this.getMenuElement(1).getCurrent(), this.getMenuElement(2).getCurrent()) * 100.0f));
        this.getMenuElement(0).setMin((int)((float)this.getMenuElement(1).getCurrent() * DiplomacyManager.takeLoan_InterestRate(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), this.getMenuElement(1).getCurrent(), this.getMenuElement(2).getCurrent()) / 100.0f));
