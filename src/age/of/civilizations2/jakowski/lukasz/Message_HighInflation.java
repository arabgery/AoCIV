...
class Message_HighInflation extends Message {
   protected Message_HighInflation(int fromCivID, int iValue) {
   ...
   protected MenuElement_Hover_v2 getHover() {
      ...
      nData.add(
         new MenuElement_Hover_v2_Element_Type_Text(
            "[" + (float)((int)(CFG.game_NextTurnUpdate.getInflationPerc(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()) * 10000.0F)) / 100.0F + "%]",
