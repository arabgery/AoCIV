...
class Menu_CreateScenario_Events_Cond_NumOfProvinces_Low
extends SliderMenu {
    protected Menu_CreateScenario_Events_Cond_NumOfProvinces_Low() {
        ...
        menuElements.add(new Slider_BG(0, tY, CFG.GAME_WIDTH, CFG.BUTTON_HEIGHT - CFG.PADDING * 2, 0, tNum, CFG.eventsManager.lCreateScenario_Event.getTrigger((int)CFG.eventsManager.iCreateEvent_EditTriggerID).lConditions.get(CFG.eventsManager.iCreateEvent_EditConditionID).getValue()){
