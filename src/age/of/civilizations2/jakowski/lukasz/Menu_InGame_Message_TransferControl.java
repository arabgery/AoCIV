...
class Menu_InGame_Message_TransferControl
extends SliderMenu {
    ...
    protected Menu_InGame_Message_TransferControl() {
    ...
    protected Menu_InGame_Message_TransferControl(int onCivID, int iMessageID, int iValue) {
        ArrayList<MenuElement> menuElements = new ArrayList<MenuElement>();
        ...
        int tempWidth = CFG.CIV_INFO_MENU_WIDTH * 2;
        int tY = 0;
        menuElements.add(new Button_Build_TransferControl(CFG.langManager.get("TakeControlOverOccupiedProvince"), CFG.game.getProvince(this.iProvinceID).getName().length() > 0 ? CFG.game.getProvince(this.iProvinceID).getName() : CFG.langManager.get("Province"), Images.transfer_control, 0, 0, 2, tY, CFG.BUTTON_WIDTH * 2){
        ...
        menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Accept"), -1, 2, tY, CFG.BUTTON_WIDTH, true){
            ...
            protected void buildElementHover() {
                ...
                nData.add(new MenuElement_Hover_v2_Element_Type_Flag(CFG.game.getProvince(Menu_InGame_Message_TransferControl.this.iProvinceID).getCivID(), CFG.PADDING, 0));
        ...
        this.initMenu(new SliderMenuTitle(CFG.langManager.get("TransferControl"), CFG.BUTTON_HEIGHT * 3 / 5, true, true){
            ...
            protected void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                ...
                ImageManager.getImage(Images.diplo_message).draw(oSB, Menu_InGame_Message_TransferControl.this.getPosX() + CFG.PADDING * 2 + iTranslateX, Menu_InGame_Message_TransferControl.this.getPosY() - this.getHeight() / 2 - ImageManager.getImage(Images.diplo_message).getHeight() / 2);
                CFG.fontMain.getData().setScale(0.8f);
