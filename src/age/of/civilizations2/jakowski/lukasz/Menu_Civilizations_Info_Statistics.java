...
class Menu_Civilizations_Info_Statistics
extends SliderMenu {
    protected Menu_Civilizations_Info_Statistics() {
        ...
        this.initMenu(new SliderMenuTitle(null, CFG.TEXT_HEIGHT + CFG.PADDING * 2, false, false){
            ...
            protected void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                ...
                ImageManager.getImage(Images.gradient).draw(oSB, Menu_Civilizations_Info_Statistics.this.getPosX() - CFG.PADDING + 2 + iTranslateX, Menu_Civilizations_Info_Statistics.this.getPosY() + 2 - ImageManager.getImage(Images.gradient).getHeight() - (this.getHeight() + CFG.PADDING * 2), Menu_Civilizations_Info_Statistics.this.getWidth() + CFG.PADDING * 2 - 2, (this.getHeight() + CFG.PADDING * 2 - 4) * 3 / 4, false, false);
                oSB.setColor(new Color(CFG.COLOR_FLAG_FRAME.r, CFG.COLOR_FLAG_FRAME.g, CFG.COLOR_FLAG_FRAME.b, 0.25f));
                ImageManager.getImage(Images.line_32_off1).draw(oSB, Menu_Civilizations_Info_Statistics.this.getPosX() - CFG.PADDING + 2 + iTranslateX, Menu_Civilizations_Info_Statistics.this.getPosY() - this.getHeight() - ImageManager.getImage(Images.line_32_off1).getHeight() + 1 - CFG.PADDING * 2, Menu_Civilizations_Info_Statistics.this.getWidth() + CFG.PADDING * 2 - 2, ImageManager.getImage(Images.line_32_off1).getHeight(), false, true);
                oSB.setColor(new Color(CFG.COLOR_FLAG_FRAME.r, CFG.COLOR_FLAG_FRAME.g, CFG.COLOR_FLAG_FRAME.b, 0.4f));
                ImageManager.getImage(Images.line_32_off1).draw(oSB, Menu_Civilizations_Info_Statistics.this.getPosX() - CFG.PADDING + 2 + iTranslateX, Menu_Civilizations_Info_Statistics.this.getPosY() - ImageManager.getImage(Images.line_32_off1).getHeight() - 2 - CFG.PADDING * 2, Menu_Civilizations_Info_Statistics.this.getWidth() + CFG.PADDING * 2 - 2, ImageManager.getImage(Images.line_32_off1).getHeight(), false, true);
