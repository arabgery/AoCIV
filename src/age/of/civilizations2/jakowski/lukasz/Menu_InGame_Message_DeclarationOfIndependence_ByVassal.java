...
class Menu_InGame_Message_DeclarationOfIndependence_ByVassal
extends SliderMenu {
    ...
    protected Menu_InGame_Message_DeclarationOfIndependence_ByVassal() {
    ...
    protected Menu_InGame_Message_DeclarationOfIndependence_ByVassal(int onCivID, int iMessageID, int iValue) {
        ...
        tY += ((MenuElement)menuElements.get(menuElements.size() - 1)).getHeight();
        menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Fine") + "!", -1, 2 + CFG.PADDING, tY += CFG.PADDING, CFG.BUTTON_WIDTH, true){
            ...
            protected void buildElementHover() {
                ...
                nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("WeWillSignATruceUntilX", Game_Calendar.getDate_ByTurnID(Game_Calendar.TURN_ID + 30))));
        ...
        menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("DeclareWar"), -1, 2, tY, CFG.BUTTON_WIDTH, true){
            ...
            protected void buildElementHover() {
                ...
                nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.game.getCiv(Menu_InGame_Message_DeclarationOfIndependence_ByVassal.this.iOnCivID).getCivName()));
        ...
        this.initMenu(new SliderMenuTitle(CFG.langManager.get("DeclarationOfIndependence"), CFG.BUTTON_HEIGHT * 3 / 5, true, true){
            ...
            protected void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                ...
                ImageManager.getImage(Images.diplo_message).draw(oSB, Menu_InGame_Message_DeclarationOfIndependence_ByVassal.this.getPosX() + CFG.PADDING * 2 + iTranslateX, Menu_InGame_Message_DeclarationOfIndependence_ByVassal.this.getPosY() - this.getHeight() / 2 - ImageManager.getImage(Images.diplo_message).getHeight() / 2);
                CFG.fontMain.getData().setScale(0.8f);
