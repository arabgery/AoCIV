...
class Button_Diplo_Opinions extends Button_Diplo_Actions {
   protected Button_Diplo_Opinions(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight, boolean isClickable) {
   ...
   protected void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ImageManager.getImage(Images.diplo_relations)
         .draw(
            ...
            this.getPosX()
               + this.getWidth() / 2
               - (ImageManager.getImage(Images.diplo_relations).getWidth() + CFG.PADDING + (int)((float)this.getTextWidth() * 0.6F)) / 2
               + iTranslateX,
