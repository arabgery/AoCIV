...
import age.of.civilizations2.jakowski.lukasz.Button_Diplomacy_Message_Pact;
...
class Menu_InGame_Message_MilitaryAccess_Ask
extends SliderMenu {
    ...
    protected Menu_InGame_Message_MilitaryAccess_Ask() {
    ...
    protected Menu_InGame_Message_MilitaryAccess_Ask(int onCivID, int iMessageID, int iValue) {
        ...
        this.initMenu(new SliderMenuTitle(CFG.langManager.get("MilitaryAccess"), CFG.BUTTON_HEIGHT * 3 / 5, true, true){
            ...
            protected void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                ...
                ImageManager.getImage(Images.diplo_message).draw(oSB, Menu_InGame_Message_MilitaryAccess_Ask.this.getPosX() + CFG.PADDING * 2 + iTranslateX, Menu_InGame_Message_MilitaryAccess_Ask.this.getPosY() - this.getHeight() / 2 - ImageManager.getImage(Images.diplo_message).getHeight() / 2);
