...
public class Button_NewGameStyle_Left extends Button {
   protected Button_NewGameStyle_Left(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, boolean isClickable) {
      super.init(sText, iTextPositionX, iPosX, iPosY, iWidth, (int)((float)CFG.BUTTON_HEIGHT * 0.65F), isClickable, true, false, false);
   }

   protected Button_NewGameStyle_Left(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight, boolean isClickable) {
