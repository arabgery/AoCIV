...
class Button_New_Game_Players extends Button {
   protected static final float BUTTON_PERC_HEIGHT = 0.6F;

   protected Button_New_Game_Players(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, boolean isClickable) {
      super.init(sText, iTextPositionX, iPosX, iPosY, iWidth, (int)((float)CFG.BUTTON_HEIGHT * 0.6F), isClickable, true, false, false);
   }

   protected Button_New_Game_Players(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight, boolean isClickable) {
