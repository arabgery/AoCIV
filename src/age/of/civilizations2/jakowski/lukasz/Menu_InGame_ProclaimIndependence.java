...
class Menu_InGame_ProclaimIndependence
extends SliderMenu {
    private int iOnCivID = -1;

    protected Menu_InGame_ProclaimIndependence() {
    ...
    protected Menu_InGame_ProclaimIndependence(int onCivID) {
        ...
        tY += ((MenuElement)menuElements.get(menuElements.size() - 1)).getHeight();
        menuElements.add(new Slider_FlagAction_Date(CFG.langManager.get("NumberOfTurns"), CFG.PADDING * 2, ((MenuElement)menuElements.get(menuElements.size() - 1)).getPosY() + ((MenuElement)menuElements.get(menuElements.size() - 1)).getHeight() + CFG.PADDING, tempWidth - CFG.PADDING * 3 - CFG.BUTTON_WIDTH, CFG.TEXT_HEIGHT + CFG.PADDING * 2 + CFG.PADDING * 4, 1, 40, 100, 0.65f){
        ...
        int tempMenuPosY = ImageManager.getImage(Images.top_left2).getHeight() + CFG.PADDING * 2 + CFG.BUTTON_HEIGHT * 3 / 5;
        this.initMenu(new SliderMenuTitle(CFG.langManager.get("ProclaimIndependence"), CFG.BUTTON_HEIGHT * 3 / 5, true, true){
    ...
    protected final void actionElement(int iID) {
        if (iID == this.getMenuElementsSize() - 1) {
            DiplomacyManager.sendGuaranteeIndependence_AskProposal(this.iOnCivID, CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), this.getMenuElement(1).getCurrent());
