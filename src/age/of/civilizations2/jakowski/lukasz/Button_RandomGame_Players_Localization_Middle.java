...
class Button_RandomGame_Players_Localization_Middle extends Button_New_Game_Players {
   protected Button_RandomGame_Players_Localization_Middle(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, boolean isClickable) {
