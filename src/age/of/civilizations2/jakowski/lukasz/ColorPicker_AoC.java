...
class ColorPicker_AoC {
   ...
   private List<ColorPicker_AoC.Box> lRGBBoxes = new ArrayList<>();
   private List<ColorPicker_AoC.Box> lColorsBoxes = new ArrayList<>();
   ...
   protected final void updateColorPicker_Action(ColorPicker_AoC.PickerAction nAction) {
      switch(nAction) {
   ...
   protected final void draw(SpriteBatch oSB, int iTranslateX) {
      ...
      if (!this.activeResize) {
         Rectangle clipBounds = new Rectangle(
            (float)(this.iPosX + iTranslateX), (float)(CFG.GAME_HEIGHT - this.iPosY), (float)this.iSVHeight, (float)(-this.iSVHeight)
         );
         oSB.flush();
   ...
   protected final void drawRGBText(SpriteBatch oSB, int boxID, int nPosX, int nPosY, int nWidth, int nHeight, String sLeft, String sRight, int nRightWidth) {
      ...
      CFG.drawText(
         oSB, sRight, nPosX + nWidth - CFG.PADDING - (int)((float)nRightWidth * 0.9F), nPosY + nHeight / 2 - CFG.TEXT_HEIGHT / 2, CFG.COLOR_TEXT_RANK
      );
            ...
            if (screenX >= this.iPosX + this.iSVHeight + CFG.PADDING
               ...
               for(int i = 0; i < this.lColorsBoxes.size(); ++i) {
                  if (this.lColorsBoxes.get(i).getVisible()
                     && screenX >= this.iPosX + this.lColorsBoxes.get(i).getPosX()
                     && screenX <= this.iPosX + this.lColorsBoxes.get(i).getPosX() + this.lColorsBoxes.get(i).getWidth()
                     && screenY >= this.iPosY + this.iSVHeight + this.lColorsBoxes.get(i).getPosY()
                     && screenY <= this.iPosY + this.iSVHeight + this.lColorsBoxes.get(i).getPosY() + this.lColorsBoxes.get(i).getHeight()) {
                     this.iActiveColorID = i;
                     if ((int)(this.activeColor.r * 255.0F) != (int)(this.lColors.get(i).r * 255.0F)
                        && (int)(this.activeColor.r * 255.0F) != (int)(this.lColors.get(i).g * 255.0F)
                        && (int)(this.activeColor.r * 255.0F) != (int)(this.lColors.get(i).b * 255.0F)) {
         ...
         if (screenX >= this.iPosX + this.iSVHeight + CFG.PADDING + this.iHUEWidth + CFG.PADDING + this.lRGBBoxes.get(i).getPosX()
            && screenX
               <= this.iPosX
                  ...
                  + this.iHUEWidth
                  + CFG.PADDING
                  + this.lRGBBoxes.get(i).getPosX()
                  + this.lRGBBoxes.get(i).getWidth()
   ...
   protected final void setVisible(boolean visible, ColorPicker_AoC.PickerAction nAction) {
      if (nAction != null) {
